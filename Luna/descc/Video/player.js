  ...
  (function () {
    ...
    var Z = {
      ...
      ee = t(function (e) {
        ...
        (e.exports = function (e, t, o, a) {
          var s = !!a && !!a.unsafe,
            ...
            u = !!a && !!a.noTargetGet;
          "function" == typeof o &&
            ("string" != typeof t || b(o, "name") || I(o, "name", t),
      ...
      Ce = function (e, t) {
        ...
        if ((n = u ? r : l ? r[c] || C(c, {}) : (r[c] || {}).prototype))
          for (i in t) {
            if (
              ((a = t[i]),
              (o = e.noTargetGet ? (s = Ie(n, i)) && s.value : n[i]),
              !Oe(u ? i : c + (l ? "." : "#") + i, e.forced) && void 0 !== o)
            ) {
      ...
      qe = function (e) {
        return (
          b(Ue, e) ||
            (Ne && b(De, e) ? (Ue[e] = De[e]) : (Ue[e] = Fe("Symbol." + e))),
          Ue[e]
        );
      },
      Be = qe("species"),
      ...
      Xe = function (e, t) {
        ...
        return (Ge[e] =
          ...
          !i(function () {
            if (r && !o) return !0;
            var e = { length: -1 };
            r ? $e(e, 1, { enumerable: !0, get: Ke }) : (e[1] = 1),
              n.call(e, a, s);
          }));
      },
      Je = ze.forEach,
    ...
    Ce(
      { target: "Array", proto: !0, forced: [].forEach != et },
      { forEach: et }
    );
    ...
    var ct = "[object z]" === String(st),
      ...
      dt = function (e) {
        var t,
          ...
          p = 0;
        if (
          (f && (l = je(l, u > 2 ? arguments[2] : void 0, 2)),
          null == h || (c == Array && ot(h)))
        )
          for (n = new c((t = ce(s.length))); t > p; p++)
            (a = f ? l(s[p], p) : s[p]), at(n, p, a);
        else
          for (
            o = (i = h.call(s)).next, n = new c();
            !(r = o.call(i)).done;
            p++
          )
            (a = f ? tt(i, l, [r.value, p], !0) : r.value), at(n, p, a);
        return (n.length = p), n;
      },
      gt = qe("iterator"),
      mt = !1;
    ...
    Ce({ target: "Array", stat: !0, forced: wt }, { from: dt });
    var _t,
      Et =
        Object.keys ||
        function (e) {
      ...
      St = o
        ...
        : function (e, t) {
            x(e);
            for (var n, r = Et(t), i = r.length, o = 0; i > o; )
              O.f(e, (n = r[o++]), t[n]);
            return e;
          },
    ...
    var It =
      ...
      Ct = qe("unscopables"),
      Pt = Array.prototype;
    null == Pt[Ct] && O.f(Pt, Ct, { configurable: !0, value: It(null) });
    var jt = function (e) {
        Pt[Ct][e] = !0;
      },
      Rt = pe.includes,
      Lt = Xe("indexOf", { ACCESSORS: !0, 1: 0 });
    Ce(
      { target: "Array", proto: !0, forced: !Lt },
      {
        includes: function (e) {
    ...
    var Nt,
      Mt,
      Ut = re("navigator", "userAgent") || "",
      Dt = r.process,
      Ft = Dt && Dt.versions,
      qt = Ft && Ft.v8;
    qt
      ? (Mt = (Nt = qt.split("."))[0] + Nt[1])
      : Ut &&
        (!(Nt = Ut.match(/Edge\/(\d+)/)) || Nt[1] >= 74) &&
        (Nt = Ut.match(/Chrome\/(\d+)/)) &&
        (Mt = Nt[1]);
    var Bt = Mt && +Mt,
      Ht = qe("species"),
      Vt = function (e) {
      ...
      Yt = Xe("map");
    Ce(
      { target: "Array", proto: !0, forced: !zt || !Yt },
      {
        map: function (e) {
    ...
    if (
      ...
      for (
        var dn = function (e, t) {
            ...
            hn
              ? i && !o && (e = e.source)
              : e instanceof dn && (o && (t = Qt.call(e)), (e = e.source)),
              pn &&
                (n = !!t && t.indexOf("y") > -1) &&
                (t = t.replace(/y/g, ""));
            var a = Kt(hn ? new cn(e, t) : cn(e, t), r ? this : un, dn);
            return pn && n && an(a, { sticky: n }), a;
          },
          gn = function (e) {
            (e in dn) ||
              rn(dn, e, {
    ...
    var kn = wn;
    Ce({ target: "RegExp", proto: !0, forced: /./.exec !== kn }, { exec: kn });
    var Tn = "toString",
      xn = RegExp.prototype,
      An = xn.toString,
      On = i(function () {
        return "/a/b" != An.call({ source: "a", flags: "b" });
      }),
      In = An.name != Tn;
    (On || In) &&
      ee(
        ...
        function () {
          ...
          return (
            ...
            "/" +
            String(
              void 0 === n && e instanceof RegExp && !("flags" in xn)
                ? Qt.call(e)
                : n
            )
          );
    ...
    [].keys &&
      ("next" in (Ln = [].keys())
        ? (Rn = qn(qn(Ln))) !== Object.prototype && (jn = Rn)
        : (Hn = !0)),
      null == jn && (jn = {}),
      b(jn, Bn) ||
        I(jn, Bn, function () {
    ...
    var Vn = { IteratorPrototype: jn, BUGGY_SAFARI_ITERATORS: Hn },
      Wn = O.f,
      zn = qe("toStringTag"),
      Yn = function (e, t, n) {
        e &&
          !b((e = n ? e : e.prototype), zn) &&
          Wn(e, zn, { configurable: !0, value: t });
      },
        ...
        if (
          (m &&
            ...
            Xn !== Object.prototype &&
              s.next &&
              (qn(s) !== Xn &&
                (Gt ? Gt(s, Xn) : "function" != typeof s[Qn] && I(s, Qn, nr)),
              Yn(s, f, !0))),
          i == er &&
            d &&
            d.name !== er &&
          ...
          if (((c = { values: l(er), keys: o ? g : l(Zn), entries: l(tr) }), a))
            for (u in c) (Jn || h || !(u in p)) && ee(p, u, c[u]);
          else Ce({ target: t, proto: !0, forced: Jn || h }, c);
        return c;
      },
      ir = Mn.charAt,
      or = "String Iterator",
    ...
    rr(
      ...
      "String",
      function (e) {
        ar(this, { type: or, string: String(e), index: 0 });
      },
      function () {
        var e,
          t = sr(this),
    ...
    document.addEventListener("focusout", function (e) {
      e.target.classList &&
        !hr.contains(e.target) &&
        e.target.classList.remove(pr);
    }),
    ...
    var dr = ye.f,
      ...
      vr = {
        f: function (e) {
          return mr && "[object Window]" == gr.call(e)
            ? (function (e) {
                try {
                  return dr(e);
                } catch (e) {
      ...
      Hr = function (e, t) {
        ...
        return (
          Tr(n, { type: Sr, tag: e, description: t }),
          o || (n.description = t),
          n
        );
      },
      ...
      Wr = function (e, t, n) {
        ...
        return (
          ...
          b(Lr, r)
            ? (n.enumerable
                ? (b(e, Er) && e[Er][r] && (e[Er][r] = !1),
                  (n = It(n, { enumerable: u(0, !1) })))
                : (b(e, Er) || Pr(e, Er, u(1, {})), (e[Er][r] = !0)),
              Br(e, r, n))
            : Pr(e, r, n)
        );
      },
      ...
      Yr = function (e) {
        var t = v(e, !0),
          n = Rr.call(this, t);
        return (
          !(this === Ar && b(Lr, t) && !b(Nr, t)) &&
          (!(n || !b(this, t) || !b(Lr, t) || (b(this, Er) && this[Er][t])) ||
            n)
        );
      },
      $r = function (e, t) {
        ...
        if (n !== Ar || !b(Lr, r) || b(Nr, r)) {
          var i = Cr(n, r);
          return (
            !i || !b(Lr, r) || (b(n, Er) && n[Er][r]) || (i.enumerable = !0), i
          );
        }
      },
      Gr = function (e) {
    ...
    if (
      (Ne ||
        (ee(
          (Or = function () {
            ...
            var e =
              ...
              n = function (e) {
                this === Ar && n.call(Nr, e),
                  b(this, Er) && b(this[Er], t) && (this[Er][t] = !1),
                  Br(this, t, u(1, e));
              };
            return o && qr && Br(Ar, t, { configurable: !0, set: n }), Hr(t, e);
          }).prototype,
          "toString",
          function () {
            return xr(this).tag;
        ...
        o &&
          ...
          ee(Ar, "propertyIsEnumerable", Yr, { unsafe: !0 }))),
      Ce({ global: !0, wrap: !0, forced: !Ne, sham: !Ne }, { Symbol: Or }),
      _r(Et(Dr), function (e) {
        wr(e);
      }),
      Ce(
        { target: Sr, stat: !0, forced: !Ne },
        {
          for: function (e) {
            var t = String(e);
      ...
      Ce(
        ...
        { getOwnPropertyNames: Gr, getOwnPropertySymbols: Kr }
      ),
      Ce(
        {
          target: "Object",
      ...
      var Xr =
        ...
        i(function () {
          var e = Or();
          return (
            "[null]" != Ir([e]) || "{}" != Ir({ a: e }) || "{}" != Ir(Object(e))
          );
        });
      Ce(
        { target: "JSON", stat: !0, forced: Xr },
        {
          stringify: function (e, t, n) {
            for (var r, i = [e], o = 1; arguments.length > o; )
              i.push(arguments[o++]);
            if (((r = t), (m(t) || void 0 !== e) && !Vr(e)))
              return (
                Le(t) ||
                  (t = function (e, t) {
                    if (
    ...
    Or.prototype[kr] || I(Or.prototype, kr, Or.prototype.valueOf),
      Yn(Or, Sr),
      (Y[Er] = !0);
    var Jr = O.f,
      Qr = r.Symbol;
    if (
      o &&
      "function" == typeof Qr &&
      (!("description" in Qr.prototype) || void 0 !== Qr().description)
    ) {
      var Zr = {},
        ei = function () {
          var e =
      ...
      Jr(ti, "description", {
        ...
        Ce({ global: !0, forced: !0 }, { Symbol: ei });
    }
    wr("iterator");
    var oi = pe.indexOf,
      ai = [].indexOf,
      ...
      ci = Ye("indexOf"),
      ui = Xe("indexOf", { ACCESSORS: !0, 1: 0 });
    Ce(
      { target: "Array", proto: !0, forced: si || !ci || !ui },
      {
        indexOf: function (e) {
          return si
            ? ai.apply(this, arguments) || 0
            : oi(this, e, arguments.length > 1 ? arguments[1] : void 0);
        },
      }
    );
    var li = "Array Iterator",
      ...
      pi = rr(
        ...
        "Array",
        function (e, t) {
          fi(this, { type: li, target: g(e), index: 0, kind: t });
        },
        function () {
          var e = hi(this),
            t = e.target,
    ...
    var vi = Vt("slice"),
      yi = Xe("slice", { ACCESSORS: !0, 0: 0, 1: 2 }),
      bi = qe("species"),
      wi = [].slice,
      _i = Math.max;
    Ce(
      { target: "Array", proto: !0, forced: !vi || !yi },
      {
        slice: function (e, t) {
          var n,
            r,
          ...
          if (
            ...
            (n !== Array && !Le(n.prototype))
              ? m(n) && null === (n = n[bi]) && (n = void 0)
              : (n = void 0),
            n === Array || void 0 === n)
          )
            return wi.call(o, s, c);
          for (
            r = new (void 0 === n ? Array : n)(_i(c - s, 0)), i = 0;
            s < c;
            s++, i++
          )
            s in o && at(r, i, o[s]);
    ...
    ct || ee(Object.prototype, "toString", Ei, { unsafe: !0 });
    var Si = qe("species"),
      ki = !i(function () {
        var e = /./;
        return (
    ...
    Ii("search", 1, function (e, t, n) {
      return [
        ...
        function (e) {
          ...
          var s = ji(i, o);
          return (
            Di(i.lastIndex, a) || (i.lastIndex = a), null === s ? -1 : s.index
          );
        },
      ];
    });
          ...
          [
            ...
            function (e, i) {
              ...
              for (var p = 0, d = 0, g = []; d < s.length; ) {
                f.lastIndex = Wi ? d : 0;
                var m,
                  v = ji(f, Wi ? s : s.slice(d));
                if (
                  null === v ||
                  (m = Hi(ce(f.lastIndex + (Wi ? 0 : d)), s.length)) === p
                )
                  d = Pi(s, d, u);
                else {
    ...
    var Qi = qe("iterator"),
      ...
      ro =
        ...
        i(function () {
          ...
          ? function (e, t) {
              for (
                var n = Re(e), r = arguments.length, i = 1, a = be.f, s = c.f;
                r > i;
                ...
                for (
                  var u,
                    l = p(arguments[i++]),
                    f = a ? Et(l).concat(a(l)) : Et(l),
                    h = f.length,
                    d = 0;
                  h > d;

                )
                  (u = f[d++]), (o && !s.call(l, u)) || (n[u] = l[u]);
              return n;
            }
          : to,
      io = 2147483647,
      ...
      fo = function (e, t, n) {
        var r = 0;
        for (e = n ? co(e / 700) : e >> 1, e += co(e / t); e > 455; r += 36)
          e = co(e / 35);
      ...
      Ro = function (e, t) {
        if (t)
          for (var n, r, i = t.split("&"), o = 0; o < i.length; )
            (n = i[o++]).length &&
              ((r = n.split("=")),
              e.push({ key: Oo(r.shift()), value: Oo(r.join("=")) }));
      },
      Lo = function (e) {
      ...
      Mo = Kn(
        function (e, t) {
          _o(this, { type: wo, iterator: go(Eo(e).entries), kind: t });
        },
        "Iterator",
        function () {
          var e = So(this),
          ...
          if (m(u))
            if ("function" == typeof (e = pt(u)))
              for (n = (t = e.call(u)).next; !(r = n.call(t)).done; ) {
                if (
                  (a = (o = (i = go(x(r.value))).next).call(i)).done ||
                  (s = o.call(i)).done ||
                  !o.call(i).done
                )
            ...
            else for (c in u) b(u, c) && f.push({ key: c, value: u[c] + "" });
          else
            Ro(
              f,
              "string" == typeof u
    ...
    po(
      Do,
      {
        ...
        delete: function (e) {
          ...
          for (
            var t = Eo(this), n = t.entries, r = e + "", i = 0;
            i < n.length;
        ...
        getAll: function (e) {
          No(arguments.length, 1);
          for (
            var t = Eo(this).entries, n = e + "", r = [], i = 0;
            i < t.length;
            i++
          )
      ...
      ee(
        ...
        "toString",
        function () {
          for (var e, t = Eo(this).entries, n = [], r = 0; r < t.length; )
            (e = t[r++]), n.push(jo(e.key) + "=" + jo(e.value));
          return n.join("&");
        },
        { enumerable: !0 }
      ),
      Yn(Uo, bo),
      Ce({ global: !0, forced: !Zi }, { URLSearchParams: Uo }),
      Zi ||
        "function" != typeof mo ||
        "function" != typeof vo ||
        Ce(
              ...
              return (
                arguments.length > 1 &&
                  (m((t = arguments[1])) &&
                    ((n = t.body),
                    ft(n) === bo &&
                      ((r = t.headers ? new vo(t.headers) : new vo()).has(
                        "content-type"
                      ) ||
                        r.set(
                          "content-type",
    ...
    var Fo,
      qo = { URLSearchParams: Uo, getState: Eo },
      Bo = Mn.codeAt,
      Ho = r.URL,
          ...
          if (
            ((t = (function (e) {
              ...
              for (t = 0; t < i.length; t++)
                (n = i[t]), r.push(oo.test(n) ? "xn--" + ho(n) : n);
              return r.join(".");
            })(t)),
            oa.test(t))
          )
      ...
      la = function (e) {
        ...
        for (n = [], r = 0; r < t; r++) {
          ...
          if (
            ...
            i.length > 1 &&
              "0" == i.charAt(0) &&
              ((o = ta.test(i) ? 16 : 8), (i = i.slice(8 == o ? 1 : 2))),
            "" === i)
          )
            a = 0;
          else {
            ...
            case Aa:
              if (o && (Zo.test(o) || "+" == o || "-" == o || "." == o))
                ...
                (f = ""),
                  "file" == e.scheme
                    ? (u = Fa)
                    : ba(e) && r && r.scheme == e.scheme
                    ? (u = Ia)
                    : ba(e)
                    ? (u = Ra)
                    : "/" == i[l + 1]
                    ? ((u = Ca), l++)
                    : ((e.cannotBeABaseURL = !0), e.path.push(""), (u = Wa));
              }
              break;
            case Oa:
            ...
            case Fa:
              if (((e.scheme = "file"), "/" == o || "\\" == o)) u = qa;
                ...
                if (o == Fo)
                  ...
                  if ("#" != o) {
                    Sa(i.slice(l).join("")) ||
                      ((e.host = r.host), (e.path = r.path.slice()), ka(e)),
                      (u = Va);
                    continue;
                  }
                  (e.host = r.host),
      ...
      Ga = function (e) {
        ...
        u.updateSearchParams(s.query),
          ...
          o ||
            ((r.href = Xa.call(r)),
            (r.origin = Ja.call(r)),
            (r.protocol = Qa.call(r)),
            (r.username = Za.call(r)),
            (r.password = es.call(r)),
            (r.host = ts.call(r)),
            (r.hostname = ns.call(r)),
            (r.port = rs.call(r)),
            (r.pathname = is.call(r)),
            (r.search = os.call(r)),
            (r.searchParams = as.call(r)),
            (r.hash = ss.call(r)));
      },
      Ka = Ga.prototype,
      Xa = function () {
    ...
    if (
      ...
      us &&
        ee(Ga, "createObjectURL", function (e) {
          return us.apply(Ho, arguments);
        }),
        ls &&
          ee(Ga, "revokeObjectURL", function (e) {
    ...
    Yn(Ga, "URL"),
      Ce({ global: !0, forced: !Zi, sham: !o }, { URL: Ga }),
      (function (e) {
        var t = (function () {
            try {
    ...
    Ce(
      { target: "Array", proto: !0, forced: !xs || !As },
      {
        concat: function (e) {
          var t,
            n,
    ...
    Ce(
      { target: "Object", stat: !0, forced: !o || Cs, sham: !o },
      {
      ...
      Ns = t(function (e) {
        ...
        (e.exports = function (e, n, r, i, o) {
          ...
          for (f = a.next; !(h = f.call(a)).done; )
            if (
              "object" == typeof (l = tt(a, p, h.value, i)) &&
              l &&
              l instanceof t
            )
              return l;
    ...
    (Ds && Fs) ||
      ...
      "process" == f(qs)
        ...
        : Bs && !Ms
        ? ((Rs = (js = new Bs()).port2),
          (js.port1.onmessage = Gs),
          (Ps = je(Rs.postMessage, Rs, 1)))
        : !r.addEventListener ||
    ...
    hc ||
      ...
      lc
        ...
        ? ((ec = !0),
          ...
          new sc(Xs).observe(tc, { characterData: !0 }),
          (Zs = function () {
            tc.data = ec = !ec;
          }))
        : uc && uc.resolve
        ? ((nc = uc.resolve(void 0)),
          (rc = nc.then),
          (Zs = function () {
            rc.call(nc, Xs);
          }))
    ...
    var pc,
      ...
      Dc = Oe(kc, function () {
        ...
        return (
          ((e.constructor = {})[Sc] = t), !(e.then(function () {}) instanceof t)
        );
      }),
      Fc =
        Dc ||
        ...
        if (!t.notified) {
          ...
          vc(function () {
            for (var i = t.value, o = 1 == t.state, a = 0; r.length > a; ) {
              ...
              try {
                f
                  ? (o || (2 === t.rejection && zc(e, t), (t.rejection = 1)),
                    !0 === f
                      ? (s = i)
                      : (d && d.enter(), (s = f(i)), d && (d.exit(), (u = !0))),
                    s === l.promise
                      ? p(Ic("Promise-chain cycle"))
                      : (c = qc(s))
                      ? c.call(s, h, p)
                      : h(s))
                  : p(i);
      ...
      Hc = function (e, t, n) {
        var i, o;
        Mc
          ? (((i = Cc.createEvent("Event")).promise = t),
            (i.reason = n),
            i.initEvent(e, !1, !0),
            r.dispatchEvent(i))
      ...
      zc = function (e, t) {
        Ec.call(r, function () {
          Nc
            ? Pc.emit("rejectionHandled", e)
            : Hc("rejectionhandled", e, t.value);
        });
      },
      Yc = function (e, t, n, r) {
        return function (i) {
    ...
    Dc &&
      ...
      ((pc = function (e) {
        ...
        then: function (e, t) {
          ...
          return (
            ...
            (r.domain = Nc ? Pc.domain : void 0),
            (n.parent = !0),
            n.reactions.push(r),
            0 != n.state && Bc(this, n, !1),
            r.promise
          );
        },
        catch: function (e) {
      ...
      (dc = function () {
        var e = new pc(),
          t = Tc(e);
        (this.promise = e),
          (this.resolve = Yc(Gc, e, t)),
          (this.reject = Yc($c, e, t));
      }),
      (bc.f = Rc =
        function (e) {
      ...
      Ce({ global: !0, wrap: !0, forced: Dc }, { Promise: Oc }),
      Yn(Oc, kc, !1),
      nn(kc),
      (gc = re(kc)),
      Ce(
        { target: kc, stat: !0, forced: Dc },
        {
          reject: function (e) {
            var t = Rc(this);
	...
	***************************************************************************** */
      ...
      return [
        ...
        function (e) {
          ...
          for (var s, c = [], u = 0; null !== (s = ji(i, o)); ) {
            var l = String(s[0]);
            (c[u] = l),
              "" === l && (i.lastIndex = Pi(o, ce(i.lastIndex), a)),
              u++;
          }
          return 0 === u ? null : c;
        },
    ...
    var bu,
      wu = "undefined" != typeof ArrayBuffer && "undefined" != typeof DataView,
      _u = O.f,
      Eu = r.Int8Array,
      Su = Eu && Eu.prototype,
    ...
    if (
      (!ju || "function" != typeof xu || xu === Function.prototype) &&
      ((xu = function () {
    ...
    var Mu = {
        ...
        exportTypedArrayStaticMethod: function (e, t, n) {
          ...
          if (o) {
            if (Gt) {
              if (n) for (i in Lu) (a = r[i]) && b(a, e) && delete a[e];
              if (xu[e] && !n) return;
              try {
      ...
      Gu = function (e, t, n) {
        ...
        for (
          (e = Vu(e)) != e || e === Hu
            ...
            : ((r = zu(Yu(e) / $u)),
              e * (o = Wu(2, -r)) < 1 && (r--, (o *= 2)),
              (e += r + u >= 1 ? l / o : l * Wu(2, 1 - u)) * o >= 2 &&
                (r++, (o /= 2)),
              r + u >= c
                ? ((i = 0), (r = c))
                : r + u >= 1
                ? ((i = (e * o - 1) * Wu(2, t)), (r += u))
                : ((i = e * Wu(2, u - 1) * Wu(2, t)), (r = 0)));
          t >= 8;
          a[h++] = 255 & i, i /= 256, t -= 8
        );
        for (
      ...
      wl = function (e, t, n, r, i, o) {
        ...
        for (
          var c = Zu(s.buffer).bytes, u = a + s.byteOffset, l = r(+i), f = 0;
          f < t;
          f++
        )
          c[u + f] = l[o ? f : t - f - 1];
    ...
    if (wu) {
      if (
        ...
        for (
          var _l,
            ...
            }).prototype = il.prototype),
            Sl = Ju(il),
            kl = 0;
          Sl.length > kl;

        )
          (_l = Sl[kl++]) in ol || I(ol, _l, il[_l]);
        El.constructor = ol;
      }
      ...
      (ol = function (e) {
        eo(this, ol, tl);
        var t = Bu(e);
        el(this, { bytes: Xu.call(new Array(t), 0), byteLength: t }),
          o || (this.byteLength = t);
      }),
        (al = function (e, t, n) {
          ...
          if (i + (n = void 0 === n ? r - i : ce(n)) > r)
            throw ul("Wrong length");
          el(this, { buffer: e, byteLength: n, byteOffset: i }),
            o ||
        ...
        po(al.prototype, {
          ...
          getInt32: function (e) {
            return gl(
              bl(this, 4, e, arguments.length > 1 ? arguments[1] : void 0)
            );
          },
          ...
          getFloat64: function (e) {
            return fl(
              bl(this, 8, e, arguments.length > 1 ? arguments[1] : void 0),
              52
            );
          },
          setInt8: function (e, t) {
    ...
    Yn(ol, tl), Yn(al, nl);
    var Al = { ArrayBuffer: ol, DataView: al },
      Ol = function (e, t) {
        var n = (function (e) {
          var t = ae(e);
    ...
    t(function (e) {
      var t = ye.f,
        ...
        k = "Wrong length",
        x = function (e, t) {
          for (var n = 0, r = t.length, i = new (_(e))(r); r > n; )
            i[n] = t[n++];
          return i;
        },
        A = function (e, t) {
        ...
        R = function (e, t, n) {
          return !(P(e, (t = v(t, !0))) && m(n) && b(n, "value")) ||
            b(n, "get") ||
            b(n, "set") ||
            n.configurable ||
      ...
      o
        ? (d ||
          ...
          Ce(
            ...
            { getOwnPropertyDescriptor: j, defineProperty: R }
          ),
          (e.exports = function (e, o, c) {
                ...
                s(e, t, {
                  ...
                  set: function (e) {
                    return (function (e, t, n) {
                      var r = i(e);
                      c && (n = (n = l(n)) < 0 ? 0 : n > 255 ? 255 : 255 & n),
                        r.view[_](t * u + r.byteOffset, n, !0);
                    })(this, t, e);
                  },
                  enumerable: !0,
                });
            ...
            d
              ...
              : ((A = o(function (e, t, n, r) {
                ...
                Gt && Gt(A, y),
                (O = A.prototype = It(w))),
              O.constructor !== A && I(O, "constructor", A),
              g && I(O, g, v),
              (P[v] = A),
              Ce({ global: !0, forced: A != T, sham: !d }, P),
              S in A || I(A, S, u),
              S in O || I(O, S, u),
              nn(v);
          }))
    ...
    (0, Mu.exportTypedArrayMethod)("filter", function (e) {
      for (
        var t = Ul(Dl(this), e, arguments.length > 1 ? arguments[1] : void 0),
          n = qi(this, this.constructor),
          r = 0,
          i = t.length,
          o = new (Fl(n))(i);
        i > r;
        ...
        ff || !hf || !pf
          ? function (e) {
              ...
              var t = g(this),
                ...
                r = n - 1;
              for (
                arguments.length > 1 && (r = uf(r, ae(arguments[1]))),
                  r < 0 && (r = n + r);
                r >= 0;
                r--
              )
    ...
    var Tf = Mu.aTypedArray,
      ...
      Af = Math.floor;
    xf("reverse", function () {
      for (var e, t = this, n = Tf(t).length, r = Af(n / 2), i = 0; i < r; )
        (e = t[i]), (t[i++] = t[--n]), (t[n] = e);
      return t;
    });
    var Of = Mu.aTypedArray;
    (0, Mu.exportTypedArrayMethod)(
      "set",
      function (e) {
        Of(this);
    ...
    (0, Mu.exportTypedArrayMethod)(
      ...
      function (e, t) {
        for (
          var n = Pf.call(If(this), e, t),
            r = qi(this, this.constructor),
            i = 0,
            o = n.length,
            a = new (Cf(r))(o);
          o > i;
    ...
    (0, Mu.exportTypedArrayMethod)("subarray", function (e, t) {
      var n = Mf(this),
        r = n.length,
        i = fe(e, r);
      return new (qi(n, n.constructor))(
        n.buffer,
        n.byteOffset + i * n.BYTES_PER_ELEMENT,
        ce((void 0 === t ? r : fe(t, r)) - i)
      );
    });
    var Uf = r.Int8Array,
      Df = Mu.aTypedArray,
    ...
    var uh = Date.now(),
      ...
      hh = (function () {
        ...
        return n && n.now
          ? (void 0 === n.timeOrigin &&
              (n.timeOrigin = (n.timing && n.timing.navigationStart) || uh),
            n)
          : fh;
      })();
    function ph() {
    ...
    var wh = vh.__SENTRY__.logger || (vh.__SENTRY__.logger = new bh()),
      _h = Vt("splice"),
      Eh = Xe("splice", { ACCESSORS: !0, 0: 0, 1: 2 }),
      Sh = Math.max,
      kh = Math.min,
      Th = 9007199254740991,
      xh = "Maximum allowed length exceeded";
    Ce(
      { target: "Array", proto: !0, forced: !_h || !Eh },
      {
        splice: function (e, t) {
          var n,
            r,
          ...
          if (
            (0 === f
              ...
              : 1 === f
              ? ((n = 0), (r = u - l))
              : ((n = f - 2), (r = kh(Sh(ae(t), 0), u - l))),
            u + n - r > Th)
          )
            throw TypeError(xh);
          for (i = He(c, r), o = 0; o < r; o++)
            (a = l + o) in c && at(i, o, c[a]);
          if (((i.length = r), n < r)) {
            for (o = l; o < u - r; o++)
    ...
    var Ah = !i(function () {
      ...
      Ih =
        (Oh.REQUIRED, Oh.fastKey, Oh.getWeakData, Oh.onFreeze, Oh.getWeakData),
      Ch = Z.set,
      Ph = Z.getterFor,
      jh = ze.find,
      Rh = ze.findIndex,
      ...
      (function (e, t, n) {
        ...
        if (
          ...
          v ||
            ...
            (u.constructor = l)),
            (g || y) && (h("delete"), h("has"), o && h("get")),
            (y || d) && h(s),
            a && u.clear && delete u.clear;
        }
        (f[e] = l),
          Ce({ global: !0, forced: l != c }, f),
          Yn(l, e),
          a || n.setStrong(l, e, o);
      })(
        "WeakSet",
        ...
        },
        {
          getConstructor: function (e, t, n, r) {
            var i = e(function (e, o) {
                eo(e, i, t),
                  Ch(e, { type: t, id: Lh++, frozen: void 0 }),
                  null != o && Ns(o, e[r], e, n);
              }),
              o = Ph(t),
              a = function (e, t, n) {
    ...
    function qh(e) {
      ...
      if (gu(e)) {
        ...
        try {
          o.currentTarget = mu(i.currentTarget)
            ? sh(i.currentTarget)
    ...
    function Vh(e, t) {
      return "domain" === t && e && "object" === fs(e) && e._events
        ? "[Domain]"
        : "domainEmitter" === t
        ? "[DomainEmitter]"
    ...
    function Wh(e, t, n, r) {
      if (
        (void 0 === n && (n = 1 / 0), void 0 === r && (r = new Dh()), 0 === n)
      )
        return (function (e) {
    ...
    var $h = ze.filter,
      ...
      Kh = Xe("filter");
    Ce(
      { target: "Array", proto: !0, forced: !Gh || !Kh },
      {
        filter: function (e) {
    ...
    var Xh,
      Jh =
        !!Ls &&
        i(function () {
          Ls.prototype.finally.call({ then: function () {} }, function () {});
        });
    Ce(
      { target: "Promise", proto: !0, real: !0, forced: Jh },
      {
        finally: function (e) {
      ...
      "function" != typeof Ls ||
        Ls.prototype.finally ||
        ee(Ls.prototype, "finally", re("Promise").prototype.finally),
      (function (e) {
        (e.PENDING = "PENDING"),
          (e.RESOLVED = "RESOLVED"),
          (e.REJECTED = "REJECTED");
              ...
              if (t._state !== Xh.PENDING) {
                ...
                (t._handlers = []),
                  e.forEach(function (e) {
                    e.done ||
                      (t._state === Xh.RESOLVED &&
                        e.onfulfilled &&
                        e.onfulfilled(t._value),
                      t._state === Xh.REJECTED &&
                        e.onrejected &&
          ...
          (e.prototype.add = function (e) {
            ...
            return this.isReady()
              ? (-1 === this._buffer.indexOf(e) && this._buffer.push(e),
                ...
                e)
              : Qh.reject(
                  new cu("Not adding Promise due to buffer limit reached.")
                );
          }),
        ...
        switch (((ap[e] = !0), e)) {
          case "console":
            !(function () {
              ...
              ["debug", "info", "warn", "error", "log", "assert"].forEach(
                function (e) {
                  e in ip.console &&
                    Fh(ip.console, e, function (t) {
                      return function () {
                        for (var n = [], r = 0; r < arguments.length; r++)
                          n[r] = arguments[r];
                        up("console", { args: n, level: e }),
          ...
          case "dom":
            !(function () {
              ...
              ip.document.addEventListener(
                "click",
                gp("click", up.bind(null, "dom")),
                !1
              ),
                ip.document.addEventListener(
                  "keypress",
                ...
                ["EventTarget", "Node"].forEach(function (e) {
                  ...
                  t &&
                    ...
                    (Fh(t, "addEventListener", function (e) {
                      return function (t, n, r) {
                        return (
                          n && n.handleEvent
                            ? ("click" === t &&
                                Fh(n, "handleEvent", function (e) {
                                  return function (t) {
                                    return (
                                      gp("click", up.bind(null, "dom"))(t),
                                      e.call(this, t)
                                    );
                                  };
                                }),
                              "keypress" === t &&
                                Fh(n, "handleEvent", function (e) {
                                  return function (t) {
                                    return (
                                      mp(up.bind(null, "dom"))(t),
                                      e.call(this, t)
                                    );
                                  };
                                }))
                            : ("click" === t &&
                                gp("click", up.bind(null, "dom"), !0)(this),
                              "keypress" === t &&
                                mp(up.bind(null, "dom"))(this)),
                          e.call(this, t, n, r)
                        );
                      };
                    }),
                ...
                return function () {
                  ...
                  return (
                    ...
                    "function" == typeof r.onreadystatechange
                      ? Fh(r, "onreadystatechange", function (e) {
                          return function () {
                            for (var t = [], n = 0; n < arguments.length; n++)
                              t[n] = arguments[n];
            ...
            !(function () {
              ...
              Fh(ip, "fetch", function (e) {
                return function () {
                  ...
                  var r = {
                    args: t,
                    fetchData: { method: lp(t), url: fp(t) },
                    startTimestamp: Date.now(),
                  };
                  return (
                    up("fetch", Zc({}, r)),
            ...
            !(function () {
              ...
              (ip.onpopstate = function () {
                ...
                var r = ip.location.href,
                  i = rp;
                if (((rp = r), up("history", { from: i, to: r }), e))
                  return e.apply(this, t);
              }),
                Fh(ip.history, "pushState", t),
                Fh(ip.history, "replaceState", t);
            })();
            break;
          case "error":
            (vp = ip.onerror),
              (ip.onerror = function (e, t, n, r, i) {
                return (
                  up("error", { column: r, error: i, line: n, msg: e, url: t }),
                  !!vp && vp.apply(this, arguments)
                );
              });
            break;
          case "unhandledrejection":
            (yp = ip.onunhandledrejection),
              (ip.onunhandledrejection = function (e) {
                return (
                  up("unhandledrejection", e), !yp || yp.apply(this, arguments)
                );
              });
            break;
          default:
    ...
    function lp(e) {
      return (
        void 0 === e && (e = []),
        "Request" in ip && yu(e[0], Request) && e[0].method
        ...
        return (
          ...
          (e.prototype._fromString = function (e) {
            ...
            var n = eu(t.slice(1), 6),
              ...
              h = f.split("/");
            if (
              (h.length > 1 && ((l = h.slice(0, -1).join("/")), (f = h.pop())),
              f)
            ) {
              var p = f.match(/^\d+/);
              p && (f = p[0]);
          ...
          (e.prototype._validate = function () {
            ...
            if (
              ...
              throw new cu("Invalid Dsn: Invalid projectId " + this.projectId);
            if ("http" !== this.protocol && "https" !== this.protocol)
              throw new cu("Invalid Dsn: Invalid protocol " + this.protocol);
            if (this.port && isNaN(parseInt(this.port, 10)))
              throw new cu("Invalid Dsn: Invalid port " + this.port);
          }),
          e
        );
      })(),
      Ep = (function () {
        ...
        return (
          (e.clone = function (t) {
            ...
            return (
              t &&
                ((n._breadcrumbs = tu(t._breadcrumbs)),
                (n._tags = Zc({}, t._tags)),
                (n._extra = Zc({}, t._extra)),
                (n._contexts = Zc({}, t._contexts)),
                (n._user = t._user),
                (n._level = t._level),
                (n._span = t._span),
                (n._transactionName = t._transactionName),
                (n._fingerprint = t._fingerprint),
                (n._eventProcessors = tu(t._eventProcessors))),
              n
            );
          }),
          ...
          (e.prototype.setTag = function (e, t) {
            var n;
            return (
              (this._tags = Zc(Zc({}, this._tags), (((n = {})[e] = t), n))),
              this._notifyScopeListeners(),
              this
            );
          }),
          (e.prototype.setExtras = function (e) {
            return (
              (this._extra = Zc(Zc({}, this._extra), e)),
              this._notifyScopeListeners(),
              this
            );
          }),
          (e.prototype.setExtra = function (e, t) {
            var n;
            return (
              (this._extra = Zc(Zc({}, this._extra), (((n = {})[e] = t), n))),
              this._notifyScopeListeners(),
              this
            );
          }),
          ...
          (e.prototype.update = function (t) {
            ...
            return (
              t instanceof e
                ? ((this._tags = Zc(Zc({}, this._tags), t._tags)),
                  (this._extra = Zc(Zc({}, this._extra), t._extra)),
                  (this._contexts = Zc(Zc({}, this._contexts), t._contexts)),
                  t._user && (this._user = t._user),
                  t._level && (this._level = t._level),
                  t._fingerprint && (this._fingerprint = t._fingerprint))
                : du(t) &&
                  ((t = t),
                  (this._tags = Zc(Zc({}, this._tags), t.tags)),
                  (this._extra = Zc(Zc({}, this._extra), t.extra)),
                  (this._contexts = Zc(Zc({}, this._contexts), t.contexts)),
          ...
          (e.prototype.addBreadcrumb = function (e, t) {
            var n = Zc({ timestamp: ph() }, e);
            return (
              (this._breadcrumbs =
                void 0 !== t && t >= 0
                  ? tu(this._breadcrumbs, [n]).slice(-t)
                  : tu(this._breadcrumbs, [n])),
              this._notifyScopeListeners(),
              this
            );
          }),
          ...
          (e.prototype.applyToEvent = function (e, t) {
            return (
              this._extra &&
                ...
                (e.extra = Zc(Zc({}, this._extra), e.extra)),
              this._tags &&
                Object.keys(this._tags).length &&
                (e.tags = Zc(Zc({}, this._tags), e.tags)),
              this._user &&
                Object.keys(this._user).length &&
                (e.user = Zc(Zc({}, this._user), e.user)),
              this._contexts &&
                Object.keys(this._contexts).length &&
                (e.contexts = Zc(Zc({}, this._contexts), e.contexts)),
              ...
              (e.breadcrumbs = tu(e.breadcrumbs || [], this._breadcrumbs)),
              (e.breadcrumbs =
                e.breadcrumbs.length > 0 ? e.breadcrumbs : void 0),
              this._notifyEventProcessors(tu(Sp(), this._eventProcessors), e, t)
            );
          }),
      ...
      return (
        ...
        (e.prototype._invokeClient = function (e) {
          ...
          i &&
            i.client &&
            i.client[e] &&
            (t = i.client)[e].apply(t, tu(n, [i.scope]));
        }),
    ...
    function Op() {
      var e = xp();
      return (
        (Ip(e) && !Cp(e).isOlderThan(3)) || Pp(e, new Tp()),
        Qf()
          ? (function (e) {
              try {
                var t = "domain",
    ...
    function Cp(e) {
      return (
        (e && e.__SENTRY__ && e.__SENTRY__.hub) ||
          ((e.__SENTRY__ = e.__SENTRY__ || {}), (e.__SENTRY__.hub = new Tp())),
        e.__SENTRY__.hub
      );
    }
    function Pp(e, t) {
    ...
    function Up(e) {
      ...
      return (
        (function (e) {
          ...
          return (
            -1 !== a.indexOf(s) &&
              r.push.apply(r, tu(r.splice(a.indexOf(s), 1))),
            r
          );
        })(e).forEach(function (e) {
          (t[e.name] = e),
            (function (e) {
              -1 === Mp.indexOf(e.name) &&
                (e.setupOnce(kp, Op),
                Mp.push(e.name),
                wh.log("Integration installed: " + e.name));
            })(e);
        }),
        t
      );
    ...
    var Dp,
        ...
        return (
                  ...
                  Zc(
                    ...
                    e.breadcrumbs && {
                      breadcrumbs: e.breadcrumbs.map(function (e) {
                        return Zc(Zc({}, e), e.data && { data: zh(e.data, t) });
                      }),
                    }
                  ),
                  e.user && { user: zh(e.user, t) }
                ),
                e.contexts && { contexts: zh(e.contexts, t) }
              ),
              e.extra && { extra: zh(e.extra, t) }
            );
            return (
              e.contexts &&
                e.contexts.trace &&
          ...
          (e.prototype._applyClientOptions = function (e) {
            ...
            void 0 === e.environment && void 0 !== n && (e.environment = n),
              ...
              e.message && (e.message = Kf(e.message, a));
          ...
          (e.prototype._processEvent = function (e, t, n) {
            var r = this,
              ...
              a = i.sampleRate;
            if (!this._isEnabled())
              return Qh.reject("SDK not enabled, will not send event.");
            var s = "transaction" === e.type;
            return !s && "number" == typeof a && Math.random() > a
              ? Qh.reject("This event has been sampled, will not send event.")
              : new Qh(function (i, a) {
      ...
      Bp = (function () {
        function e(e) {
          (this._options = e),
            this._options.dsn ||
              wh.warn("No DSN provided, backend will not do anything."),
    ...
    var Vp = (function () {
      ...
      Yp = Xe("some");
    Ce(
      { target: "Array", proto: !0, forced: !zp || !Yp },
      {
        some: function (e) {
          ...
          (e.prototype._getPossibleEventMessages = function (e) {
            ...
            if (e.exception)
              try {
                ...
                return (
                  wh.error("Cannot extract message for event " + rh(e)), []
                );
              }
            return [];
          }),
      ...
      try {
        if (
          (t = (function (e) {
            ...
            return { message: id(e), name: e.name, stack: a };
          })(e))
        )
          return rd(t, n);
      } catch (e) {}
          ...
          (t = (function (e) {
            ...
            for (
              ...
              if ((n = Xp.exec(o[a]))) {
                ...
                n[3] && n[3].indexOf(" > eval") > -1 && (t = Zp.exec(n[3]))
                  ? ((n[1] = n[1] || "eval"),
                    (n[3] = t[1]),
                    (n[4] = t[2]),
                    (n[5] = ""))
            ...
            return { message: id(e), name: e.name, stack: i };
          })(e))
        )
          return rd(t, n);
      } catch (e) {}
      return { message: id(e), name: e && e.name, stack: [], failed: !0 };
    }
    function rd(e, t) {
      try {
        return Zc(Zc({}, e), { stack: e.stack.slice(t) });
      } catch (t) {
        return e;
      }
    }
    ...
    function cd(e, t, n) {
      var r, i;
      if ((void 0 === n && (n = {}), lu(e) && e.error))
        return (r = ad(nd((e = e.error))));
      if (
        fu(e) ||
      ...
      return uu(e)
        ...
        ? (ah(
          ...
          r)
        : (oh((r = ud(e, t, n)), "" + e, void 0), ah(r, { synthetic: !0 }), r);
    }
    function ud(e, t, n) {
      void 0 === n && (n = {});
      var r = { message: e };
    ...
    var ld = (function () {
        function e(e) {
          (this.options = e),
            (this._buffer = new Zh(30)),
            (this._api = new Np(this.options.dsn)),
                    ...
                    .then(function (n) {
                      ...
                      if (r !== Qc.Success) {
                        if (r === Qc.RateLimit) {
                          ...
                          (t._disabledUntil = new Date(o + dh(o, a))),
                            wh.warn(
          ...
          throw (
            ...
            Lp(function (n) {
              n.addEventProcessor(function (e) {
                var n = Zc({}, e);
                return (
                  t.mechanism && (oh(n, void 0, void 0), ah(n, t.mechanism)),
                  (n.extra = Zc(Zc({}, n.extra), { arguments: r })),
                  n
                );
              }),
                Rp(e);
    ...
    function bd(e) {
      if ((void 0 === e && (e = {}), e.eventId))
        if (e.dsn) {
          ...
          (t.async = !0),
            (t.src = new Np(e.dsn).getReportDialogEndpoint(e)),
    ...
    var wd = (function () {
        function e(t) {
          (this.name = e.id),
            ...
            (this._options = Zc({ onerror: !0, onunhandledrejection: !0 }, t));
        }
        return (
          (e.prototype.setupOnce = function () {
            (Error.stackTraceLimit = 50),
              this._options.onerror &&
                (wh.log("Global Handler attached: onerror"),
                this._installGlobalOnErrorHandler()),
              this._options.onunhandledrejection &&
                (wh.log("Global Handler attached: onunhandledrejection"),
            ...
            this._onUnhandledRejectionHandlerInstalled ||
              (cp({
                callback: function (n) {
                  ...
                  (c.level = Jc.Error),
                    ah(c, { handled: !1, type: "onunhandledrejection" }),
                    i.captureEvent(c, { originalException: r });
                },
        ...
        return (
          (e.prototype.setupOnce = function () {
            ...
            (this._options.setTimeout &&
              Fh(e, "setTimeout", this._wrapTimeFunction.bind(this)),
            this._options.setInterval &&
              Fh(e, "setInterval", this._wrapTimeFunction.bind(this)),
            this._options.requestAnimationFrame &&
              Fh(e, "requestAnimationFrame", this._wrapRAF.bind(this)),
            this._options.XMLHttpRequest &&
              "XMLHttpRequest" in e &&
              Fh(XMLHttpRequest.prototype, "send", this._wrapXHR.bind(this)),
          ...
          (e.prototype._wrapRAF = function (e) {
            return function (t) {
              return e.call(
                ...
                yd(t, {
                  mechanism: {
                    data: { function: "requestAnimationFrame", handler: mh(e) },
                    handled: !0,
                    type: "instrument",
                  },
                })
          ...
          (e.prototype._wrapEventTarget = function (e) {
            ...
            n &&
              ...
              (Fh(n, "addEventListener", function (t) {
                return function (n, r, i) {
                  try {
                    "function" == typeof r.handleEvent &&
                      (r.handleEvent = yd(r.handleEvent.bind(r), {
                        mechanism: {
                          data: {
        ...
        return (
          ...
          (e.prototype._consoleBreadcrumb = function (e) {
            ...
            if ("assert" === e.level) {
              ...
              (t.message =
                "Assertion failed: " +
                (Xf(e.args.slice(1), " ") || "console.assert")),
                (t.data.arguments = e.args.slice(1));
            }
            Op().addBreadcrumb(t, { input: e.args, level: e.level });
          }),
      ...
      kd = (function () {
        ...
        return (
          ...
          (e.prototype._walkErrorTree = function (e, t, n) {
            if (
              (void 0 === n && (n = []),
              !yu(e[t], Error) || n.length + 1 >= this._limit)
            )
              return n;
            var r = od(nd(e[t]));
          ...
          (e.prototype.setupOnce = function () {
            kp(function (t) {
              if (Op().getIntegration(e)) {
                ...
                var n = t.request || {};
                return (
                  (n.url = n.url || Td.location.href),
                  (n.headers = n.headers || {}),
                  (n.headers["User-Agent"] = Td.navigator.userAgent),
                  Zc(Zc({}, t), { request: n })
                );
              }
              return t;
        ...
        return (
          ...
          (t.prototype.showReportDialog = function (e) {
            void 0 === e && (e = {}),
              eh().document &&
                (this._isEnabled()
                  ? bd(Zc(Zc({}, e), { dsn: e.dsn || this.getDsn() }))
                  : wh.error(
            ...
            return (
              ...
              (t.sdk = Zc(Zc({}, t.sdk), {
                ...
                packages: tu((t.sdk && t.sdk.packages) || [], [
                  { name: "npm:@sentry/browser", version: Ad },
                ]),
                version: Ad,
              })),
    ...
    function Cd(e) {
      if (
        (void 0 === e && (e = {}),
        void 0 === e.defaultIntegrations && (e.defaultIntegrations = Id),
        void 0 === e.release)
      ) {
        var t = eh();
        t.SENTRY_RELEASE &&
    ...
    jd in [] &&
      ...
      Ce(
        { target: "Array", proto: !0, forced: Rd || !Ld },
        {
          find: function (e) {
    ...
    var Nd = "[\t\n\v\f\r                　\u2028\u2029\ufeff]",
      ...
      Fd = { start: Dd(1), end: Dd(2), trim: Dd(3) },
      qd = ye.f,
      Bd = T.f,
      Hd = O.f,
      Vd = Fd.trim,
    ...
    if (Oe(Wd, !zd(" 0o1") || !zd("0b1") || zd("+0x1"))) {
      for (
        ...
        b(zd, (Kd = Jd[Qd])) && !b(Xd, Kd) && Hd(Xd, Kd, Bd(zd, Kd));
    ...
    var Zd = c.f,
      eg = function (e) {
        return function (t) {
          for (var n, r = g(t), i = Et(r), a = i.length, s = 0, c = []; a > s; )
            (n = i[s++]), (o && !Zd.call(r, n)) || c.push(e ? [n, r[n]] : r[n]);
          return c;
        };
      },
      tg = { entries: eg(!0), values: eg(!1) }.entries;
    function ng(e, t) {
      if (!(e instanceof t))
        throw new TypeError("Cannot call a class as a function");
    }
    ...
    var sg = function (e) {
      ...
      Sg = function (e) {
        return (
          ug(e) ||
          ((fg(e) || hg(e) || pg(e)) && !e.length) ||
          (lg(e) && !Object.keys(e).length)
        );
      },
      kg = {
        facebook: {
        ...
        github: {
          ...
          url: function (e, t) {
            return "https://api.github.com/repos/"
              .concat(e)
              .concat(vg(t) ? "?access_token=".concat(t) : "");
          },
          shareCount: function (e) {
    ...
    function Rg() {
      ...
      return gg(i)
        ? (Object.keys(i).forEach(function (t) {
            gg(i[t])
              ? (!Object.keys(e).includes(t) && Object.assign(e, og({}, t, {})),
                Rg(e[t], i[t]))
              : Object.assign(e, og({}, t, i[t]));
          }),
          Rg.apply(void 0, [e].concat(n)))
        : e;
    }
    var Lg = (function () {
      function e(t, n) {
    ...
    var Ng = (function () {
        function e(t, n) {
          ...
          ng(this, e),
            ...
            _g(t)
              ...
              : vg(t) && (this.elements.trigger = document.querySelector(t)),
            _g(this.elements.trigger) &&
              Sg(this.elements.trigger.shr) &&
              ((this.config = Rg({}, Tg, n, { networks: kg })),
              (this.console = new Og(this.config.debug)),
              (this.storage = new Lg(
          ...
          ig(
            ...
            [
                ...
                value: function () {
                  ...
                  return new Promise(function (n, r) {
                    ...
                    if (Sg(i))
                      r(
                        new Error(
                          "No URL available for ".concat(e.network, ".")
                        )
                      );
                    else {
                      if (t) {
                      ...
                      xg(i)
                        .then(function (t) {
                          var r = 0,
                            i =
                              e.elements.trigger.getAttribute(
                                "data-shr-display"
                              );
                          (r = Sg(i) ? e.networkConfig.shareCount(t) : t[i]),
                            Sg(r)
                              ? (r = 0)
                              : ((r = parseInt(r, 10)), !mg(r) && (r = 0)),
                            e.storage.set(
                              og({}, e.target, og({}, e.network, r))
                            ),
                            n(r);
                        })
                        .catch(r);
                ...
                value: function (e) {
                  ...
                  if (0 < o || r.displayZero) {
                    ...
                    r.format &&
                      (1e6 < o
                        ? (c = "".concat(s(1e6), "M"))
                        : 1e3 < o && (c = "".concat(s(1e3), "K"))),
                      _g(this.elements.count)
                        ? (this.elements.count.textContent = c)
                        : (Cg(
                            this.elements.trigger,
                            Pg("span", { class: i.className })
                          ),
                          (this.elements.count = Pg(
                            "span",
                            {
                              class: ""
                                .concat(r.className, " ")
              ...
              },
              {
                key: "href",
                get: function () {
                  return _g(this.elements.trigger)
      ...
      Ug =
        Mg("object" == typeof globalThis && globalThis) ||
        Mg("object" == typeof window && window) ||
        Mg("object" == typeof self && self) ||
        Mg("object" == typeof e && e) ||
        (function () {
          return this;
        })() ||
        Function("return this")(),
      ...
      Jg = function (e, t) {
        if (!Xg(e)) return e;
        var n, r;
        if (t && "function" == typeof (n = e.toString) && !Xg((r = n.call(e))))
          return r;
        if ("function" == typeof (n = e.valueOf) && !Xg((r = n.call(e))))
          return r;
        if (!t && "function" == typeof (n = e.toString) && !Xg((r = n.call(e))))
          return r;
        throw TypeError("Can't convert object to primitive value");
      ...
      rm =
        ...
        !Dg(function () {
          return (
            7 !=
            Object.defineProperty(nm("div"), "a", {
              get: function () {
                return 7;
              },
            }).a
    ...
    "function" != typeof hm.inspectSource &&
      (hm.inspectSource = function (e) {
        return pm.call(e);
      });
    var dm,
      gm,
    ...
    var Rm,
      ...
      Mm = t(function (e) {
        ...
        (e.exports = function (e, t, i, o) {
          var a,
            ...
            u = !!o && !!o.noTargetGet;
          "function" == typeof i &&
            ("string" != typeof t || Zg(i, "name") || um(i, "name", t),
            (a = n(i)).source ||
      ...
      hv = function (e, t) {
        ...
        if ((n = c ? Ug : u ? Ug[s] || lm(s, {}) : (Ug[s] || {}).prototype))
          for (r in t) {
            if (
              ((o = t[r]),
              (i = e.noTargetGet ? (a = fv(n, r)) && a.value : n[r]),
              !lv(c ? r : s + (u ? "." : "#") + r, e.forced) && void 0 !== i)
            ) {
      ...
      _v = function (e) {
        return (
          Zg(yv, e) ||
            (mv && Zg(bv, e) ? (yv[e] = bv[e]) : (yv[e] = wv("Symbol." + e))),
          yv[e]
        );
      },
      Ev = _v("species"),
      Sv = function (e, t) {
        ...
        return (
          pv(e) &&
            ("function" != typeof (n = e.constructor) ||
            (n !== Array && !pv(n.prototype))
              ? Xg(n) && null === (n = n[Ev]) && (n = void 0)
              : (n = void 0)),
          new (void 0 === n ? Array : n)(0 === t ? 0 : t)
        );
      },
      ...
      Av = xv && xv.v8;
    Av
      ? (Lm = (Rm = Av.split("."))[0] + Rm[1])
      : kv &&
        (!(Rm = kv.match(/Edge\/(\d+)/)) || Rm[1] >= 74) &&
        (Rm = kv.match(/Chrome\/(\d+)/)) &&
        (Lm = Rm[1]);
    var Ov = Lm && +Lm,
      Iv = _v("species"),
      Cv = function (e) {
    ...
    var Uv = function (e) {
      ...
      zv = function (e, t) {
        ...
        return (Vv[e] =
          ...
          !Dg(function () {
            if (r && !Fg) return !0;
            var e = { length: -1 };
            r ? Hv(e, 1, { enumerable: !0, get: Wv }) : (e[1] = 1),
              n.call(e, i, o);
          }));
      },
      Yv = Bv.filter,
      ...
      Gv = zv("filter");
    hv(
      { target: "Array", proto: !0, forced: !$v || !Gv },
      {
        filter: function (e) {
    ...
    var Kv,
      ...
      Jv = Fg
        ...
        : function (e, t) {
            am(e);
            for (var n, r = Xv(t), i = r.length, o = 0; i > o; )
              cm.f(e, (n = r[o++]), t[n]);
            return e;
          },
      ...
      ny = function () {
        ...
        ny = Kv
          ...
          : (((t = nm("iframe")).style.display = "none"),
            Qv.appendChild(t),
            (t.src = String("javascript:")),
            (e = t.contentWindow.document).open(),
            e.write(ty("document.F=Object")),
            e.close(),
            e.F);
    ...
    var ry =
      ...
      iy = _v("unscopables"),
      oy = Array.prototype;
    null == oy[iy] && cm.f(oy, iy, { configurable: !0, value: ry(null) });
    var ay = function (e) {
        oy[iy][e] = !0;
      },
      sy = Bv.find,
    ...
    cy in [] &&
      ...
      hv(
        { target: "Array", proto: !0, forced: uy || !ly },
        {
          find: function (e) {
    ...
    var yy = "[object z]" === String(vy),
      ...
      _y = yy
        ...
        : function (e) {
            ...
            return void 0 === e
              ...
              : wy
              ? zg(t)
              : "Object" == (r = zg(t)) && "function" == typeof t.callee
              ? "Arguments"
              : r;
          },
      Ey = _v("iterator"),
      ...
      ky = function (e) {
        var t,
          ...
          p = 0;
        if (
          (f && (l = Dv(l, u > 2 ? arguments[2] : void 0, 2)),
          null == h || (c == Array && my(h)))
        )
          for (n = new c((t = Wm(s.length))); t > p; p++)
            (a = f ? l(s[p], p) : s[p]), gv(n, p, a);
        else
          for (
            o = (i = h.call(s)).next, n = new c();
            !(r = o.call(i)).done;
            ...
            (a = f ? hy(i, l, [r.value, p], !0) : r.value), gv(n, p, a);
        return (n.length = p), n;
      },
      Ty = _v("iterator"),
      xy = !1;
    ...
    hv({ target: "Array", stat: !0, forced: Cy }, { from: ky });
    var Py = Km.includes,
      jy = zv("indexOf", { ACCESSORS: !0, 1: 0 });
    hv(
    ...
    [].keys &&
      ("next" in (Ny = [].keys())
        ? (Ly = Fy(Fy(Ny))) !== Object.prototype && (Ry = Ly)
        : (By = !0)),
      null == Ry && (Ry = {}),
      Zg(Ry, qy) ||
        um(Ry, qy, function () {
    ...
    var Hy = { IteratorPrototype: Ry, BUGGY_SAFARI_ITERATORS: By },
      Vy = cm.f,
      Wy = _v("toStringTag"),
      zy = function (e, t, n) {
        e &&
          !Zg((e = n ? e : e.prototype), Wy) &&
          Vy(e, Wy, { configurable: !0, value: t });
      },
        ...
        if (
          (m &&
            ...
            Xy !== Object.prototype &&
              s.next &&
              (Fy(s) !== Xy &&
                (Ky ? Ky(s, Xy) : "function" != typeof s[Qy] && um(s, Qy, nb)),
              zy(s, f, !0))),
          i == eb &&
            d &&
            d.name !== eb &&
          ...
          if (((c = { values: l(eb), keys: o ? g : l(Zy), entries: l(tb) }), a))
            for (u in c) (Jy || h || !(u in p)) && Mm(p, u, c[u]);
          else hv({ target: t, proto: !0, forced: Jy || h }, c);
        return c;
      },
      ib = "Array Iterator",
      ob = Nm.set,
      ...
      sb = rb(
        ...
        "Array",
        function (e, t) {
          ob(this, { type: ib, target: Kg(e), index: 0, kind: t });
        },
        function () {
          var e = ab(this),
            t = e.target,
    ...
    var cb = function (e, t) {
      ...
      fb = cb("join", ",");
    hv(
      { target: "Array", proto: !0, forced: lb || !fb },
      {
        join: function (e) {
    ...
    var hb = Bv.map,
      ...
      db = zv("map");
    hv(
      { target: "Array", proto: !0, forced: !pb || !db },
      {
        map: function (e) {
    ...
    var gb = function (e, t, n) {
      ...
      _b = { start: wb(1), end: wb(2), trim: wb(3) },
      Eb = ev.f,
      Sb = om.f,
      kb = cm.f,
      Tb = _b.trim,
    ...
    if (lv(xb, !Ab(" 0o1") || !Ab("0b1") || Ab("+0x1"))) {
      for (
        ...
        Zg(Ab, (Pb = Rb[Lb])) && !Zg(jb, Pb) && kb(jb, Pb, Sb(Ab, Pb));
    ...
    hv(
      { target: "Object", stat: !0, forced: Nb },
      {
        keys: function (e) {
          return Xv(dv(e));
        },
    ...
    yy || Mm(Object.prototype, "toString", Mb, { unsafe: !0 });
    var Ub = Hg.f,
      Db = function (e) {
        return function (t) {
          for (
            var n, r = Kg(t), i = Xv(r), o = i.length, a = 0, s = [];
            o > a;

          )
            (n = i[a++]),
              (Fg && !Ub.call(r, n)) || s.push(e ? [n, r[n]] : r[n]);
          return s;
        };
      },
      Fb = { entries: Db(!0), values: Db(!1) },
      qb = Fb.values;
    hv(
      { target: "Object", stat: !0 },
      {
          ...
          a
            ? r
              ? ((r.input = r.input.slice(u)),
                ...
                (o.lastIndex += r[0].length))
              : (o.lastIndex = 0)
            : $b && r && (o.lastIndex = o.global ? r.index + r[0].length : t),
          Kb &&
            r &&
            r.length > 1 &&
            zb.call(r[0], n, function () {
              for (i = 1; i < arguments.length - 2; i++)
                void 0 === arguments[i] && (r[i] = void 0);
            }),
          r
    ...
    var Xb = Yb;
    hv({ target: "RegExp", proto: !0, forced: /./.exec !== Xb }, { exec: Xb });
    var Jb = "toString",
      Qb = RegExp.prototype,
      Zb = Qb.toString,
      ew = Dg(function () {
        return "/a/b" != Zb.call({ source: "a", flags: "b" });
      }),
      tw = Zb.name != Jb;
    (ew || tw) &&
      Mm(
        ...
        function () {
          ...
          return (
            ...
            "/" +
            String(
              void 0 === n && e instanceof RegExp && !("flags" in Qb)
                ? Bb.call(e)
                : n
            )
          );
    ...
    hv(
      { target: "String", proto: !0, forced: !aw("includes") },
      {
        includes: function (e) {
          return !!~String(Gg(this)).indexOf(
            iw(e),
            arguments.length > 1 ? arguments[1] : void 0
          );
        },
    ...
    rb(
      ...
      "String",
      function (e) {
        fw(this, { type: lw, string: String(e), index: 0 });
      },
      function () {
        var e,
          t = hw(this),
        ...
        return r >= n.length
          ? { value: void 0, done: !0 }
          : ((e = uw(n, r)), (t.index += e.length), { value: e, done: !1 });
      }
    );
    var pw = _v("species"),
      dw = !Dg(function () {
    ...
    bw("search", 1, function (e, t, n) {
      return [
        ...
        function (e) {
          ...
          var s = _w(i, o);
          return (
            ww(i.lastIndex, a) || (i.lastIndex = a), null === s ? -1 : s.index
          );
        },
      ];
    });
    ...
    var Uw = {
        getConstructor: function (e, t, n, r) {
          var i = e(function (e, o) {
              Aw(e, i, t),
                Iw(e, { type: t, id: Rw++, frozen: void 0 }),
                null != o && xw(o, e[r], { that: e, AS_ENTRIES: n });
            }),
            o = Cw(t),
            a = function (e, t, n) {
              var r = o(e),
              ...
              if (
                ...
                d ||
                  (((c = t(function (t, n) {
                    ...
                    var i = gb(new a(), t, c);
                    return (
                      null != n && xw(n, i[o], { that: i, AS_ENTRIES: r }), i
                    );
                  })).prototype = s),
                  (s.constructor = c)),
                  (p || g) && (l("delete"), l("has"), r && l("get")),
                  (g || h) && l(o),
                  i && s.clear && delete s.clear;
              }
              return (
                (u[e] = c),
                hv({ global: !0, forced: c != a }, u),
                zy(c, e),
                i || n.setStrong(c, e, r),
                c
              );
            ...
            Ew(s, {
              ...
              get: function (e) {
                if (Xg(e) && !i(e)) {
                  ...
                  return (
                    r.frozen || (r.frozen = new t()),
                    u.call(this, e) ? l.call(this, e) : r.frozen.get(e)
                  );
                }
              ...
              set: function (e, r) {
                if (Xg(e) && !i(e)) {
                  ...
                  o.frozen || (o.frozen = new t()),
                    u.call(this, e) ? f.call(this, e, r) : o.frozen.set(e, r);
    ...
    var Yw = Bv.every,
      ...
      Gw = zv("every");
    hv(
      { target: "Array", proto: !0, forced: !$w || !Gw },
      {
        every: function (e) {
    ...
    hv(
      { target: "Array", proto: !0, forced: [].forEach != Qw },
      { forEach: Qw }
    );
    var Zw = Km.indexOf,
      e_ = [].indexOf,
      ...
      n_ = cb("indexOf"),
      r_ = zv("indexOf", { ACCESSORS: !0, 1: 0 });
    hv(
      { target: "Array", proto: !0, forced: t_ || !n_ || !r_ },
      {
        indexOf: function (e) {
          return t_
            ? e_.apply(this, arguments) || 0
            : Zw(this, e, arguments.length > 1 ? arguments[1] : void 0);
        },
      }
    );
    var i_ = Object.assign,
      ...
      a_ =
        ...
        Dg(function () {
              ...
              i_(
                ...
                i_(
                  o_({}, "a", {
                    enumerable: !0,
                    get: function () {
                      o_(this, "b", { value: 3, enumerable: !1 });
                    },
                  }),
                  { b: 2 }
                )
          ...
          ? function (e, t) {
              for (
                var n = dv(e), r = arguments.length, i = 1, o = tv.f, a = Hg.f;
                r > i;
                ...
                for (
                  var s,
                    c = $g(arguments[i++]),
                    u = o ? Xv(c).concat(o(c)) : Xv(c),
                    l = u.length,
                    f = 0;
                  l > f;

                )
                  (s = u[f++]), (Fg && !a.call(c, s)) || (n[s] = c[s]);
              return n;
            }
          : i_;
    hv(
      { target: "Object", stat: !0, forced: Object.assign !== a_ },
      { assign: a_ }
    );
    var s_ = _v("species"),
      c_ = function (e, t) {
          ...
          [
            ...
            function (e, i) {
              ...
              for (var p = 0, d = 0, g = []; d < s.length; ) {
                f.lastIndex = d_ ? d : 0;
                var m,
                  v = _w(f, d_ ? s : s.slice(d));
                if (
                  null === v ||
                  (m = h_(Wm(f.lastIndex + (d_ ? 0 : d)), s.length)) === p
                )
                  d = l_(s, d, u);
                else {
                  if ((g.push(s.slice(p, d)), g.length === h)) return g;
    ...
    var b_ = _v("iterator"),
      ...
      O_ = function (e, t, n) {
        var r = 0;
        for (e = n ? T_(e / 700) : e >> 1, e += T_(e / t); e > 455; r += 36)
          e = T_(e / 35);
      ...
      G_ = function (e, t) {
        if (t)
          for (var n, r, i = t.split("&"), o = 0; o < i.length; )
            (n = i[o++]).length &&
              ((r = n.split("=")),
              e.push({ key: V_(r.shift()), value: V_(r.join("=")) }));
      },
      K_ = function (e) {
      ...
      J_ = Gy(
        function (e, t) {
          M_(this, { type: N_, iterator: C_(U_(e).entries), kind: t });
        },
        "Iterator",
        function () {
          var e = D_(this),
        ...
        if (
          ...
          if (Xg(u))
            if ("function" == typeof (e = Sy(u)))
              for (n = (t = e.call(u)).next; !(r = n.call(t)).done; ) {
                if (
                  (a = (o = (i = C_(am(r.value))).next).call(i)).done ||
                  (s = o.call(i)).done ||
                  !o.call(i).done
                )
                  throw TypeError("Expected sequence with length 2");
            ...
            else for (c in u) Zg(u, c) && f.push({ key: c, value: u[c] + "" });
          else
            G_(
              f,
              "string" == typeof u
    ...
    Ew(
      Z_,
      {
        ...
        delete: function (e) {
          ...
          for (
            var t = U_(this), n = t.entries, r = e + "", i = 0;
            i < n.length;
        ...
        getAll: function (e) {
          X_(arguments.length, 1);
          for (
            var t = U_(this).entries, n = e + "", r = [], i = 0;
            i < t.length;
            i++
          )
            t[i].key === n && r.push(t[i].value);
        ...
        forEach: function (e) {
          for (
            var t,
              n = U_(this).entries,
              r = Dv(e, arguments.length > 1 ? arguments[1] : void 0, 3),
              i = 0;
            i < n.length;
      ...
      Mm(
        ...
        "toString",
        function () {
          for (var e, t = U_(this).entries, n = [], r = 0; r < t.length; )
            (e = t[r++]), n.push($_(e.key) + "=" + $_(e.value));
          return n.join("&");
        },
        { enumerable: !0 }
      ),
      zy(Q_, L_),
      hv({ global: !0, forced: !w_ }, { URLSearchParams: Q_ }),
      w_ ||
        "function" != typeof P_ ||
        "function" != typeof j_ ||
        hv(
              ...
              return (
                arguments.length > 1 &&
                  (Xg((t = arguments[1])) &&
                    ((n = t.body),
                    _y(n) === L_ &&
                      ((r = t.headers ? new j_(t.headers) : new j_()).has(
                        "content-type"
                      ) ||
                        r.set(
                          "content-type",
    ...
    var eE,
      tE = { URLSearchParams: Q_, getState: U_ },
      nE = cw.codeAt,
      rE = Ug.URL,
        ...
        if ("[" == t.charAt(0)) {
          ...
          if (
            ((t = (function (e) {
              ...
              for (t = 0; t < i.length; t++)
                (n = i[t]), r.push(E_.test(n) ? "xn--" + I_(n) : n);
              return r.join(".");
            })(t)),
            wE.test(t))
          )
      ...
      TE = function (e) {
        ...
        for (n = [], r = 0; r < t; r++) {
          ...
          if (
            ...
            i.length > 1 &&
              "0" == i.charAt(0) &&
              ((o = mE.test(i) ? 16 : 8), (i = i.slice(8 == o ? 1 : 2))),
            "" === i)
          )
            a = 0;
          else {
      ...
      RE = { ftp: 21, file: null, http: 80, https: 443, ws: 80, wss: 443 },
      LE = function (e) {
            ...
            case HE:
              if (o && (dE.test(o) || "+" == o || "-" == o || "." == o))
                ...
                (f = ""),
                  "file" == e.scheme
                    ? (u = eS)
                    : LE(e) && r && r.scheme == e.scheme
                    ? (u = WE)
                    : LE(e)
                    ? (u = GE)
                    : "/" == i[l + 1]
                    ? ((u = zE), l++)
                    : ((e.cannotBeABaseURL = !0), e.path.push(""), (u = oS));
              }
              break;
            case VE:
            ...
            case eS:
              if (((e.scheme = "file"), "/" == o || "\\" == o)) u = tS;
                ...
                if (o == eE)
                  ...
                  if ("#" != o) {
                    DE(i.slice(l).join("")) ||
                      ((e.host = r.host), (e.path = r.path.slice()), FE(e)),
                      (u = iS);
                    continue;
                  }
                  (e.host = r.host),
      ...
      uS = function (e) {
        ...
        c.updateSearchParams(a.query),
          ...
          Fg ||
            ((r.href = fS.call(r)),
            (r.origin = hS.call(r)),
            (r.protocol = pS.call(r)),
            (r.username = dS.call(r)),
            (r.password = gS.call(r)),
            (r.host = mS.call(r)),
            (r.hostname = vS.call(r)),
            (r.port = yS.call(r)),
            (r.pathname = bS.call(r)),
            (r.search = wS.call(r)),
            (r.searchParams = _S.call(r)),
            (r.hash = ES.call(r)));
      },
      lS = uS.prototype,
      fS = function () {
    ...
    if (
      ...
      kS &&
        Mm(uS, "createObjectURL", function (e) {
          return kS.apply(rE, arguments);
        }),
        TS &&
          Mm(uS, "revokeObjectURL", function (e) {
            return TS.apply(rE, arguments);
          });
    }
    zy(uS, "URL"), hv({ global: !0, forced: !w_, sham: !Fg }, { URL: uS });
    var xS = Bv.some,
      AS = cb("some"),
      OS = zv("some");
    hv(
      { target: "Array", proto: !0, forced: !AS || !OS },
      {
        some: function (e) {
    ...
    hv(
      { target: "Number", proto: !0, forced: RS },
      {
        toFixed: function (e) {
          var t,
            n,
            ...
            i,
            o = (function (e) {
              if ("number" != typeof e && "Number" != zg(e))
                throw TypeError("Incorrect invocation");
              return +e;
            })(this),
            a = Hm(e),
            ...
            l = function (e, t) {
              for (var n = -1, r = t; ++n < 6; )
                (r += e * s[n]), (s[n] = r % 1e7), (r = PS(r / 1e7));
            },
            f = function (e) {
              for (var t = 6, n = 0; --t >= 0; )
                (n += s[t]), (s[t] = PS(n / e)), (n = (n % e) * 1e7);
            },
            h = function () {
              for (var e = 6, t = ""; --e >= 0; )
                if ("" !== t || 0 === e || 0 !== s[e]) {
    ...
    var qS = ev.f,
      ...
      VS = {
        f: function (e) {
          return HS && "[object Window]" == BS.call(e)
            ? (function (e) {
                try {
                  return qS(e);
                } catch (e) {
      ...
      pk = function (e, t) {
        ...
        return (
          XS(n, { type: GS, tag: e, description: t }),
          Fg || (n.description = t),
          n
        );
      },
      ...
      gk = function (e, t, n) {
        ...
        return (
          ...
          Zg(ok, r)
            ? (n.enumerable
                ? (Zg(e, $S) && e[$S][r] && (e[$S][r] = !1),
                  (n = ry(n, { enumerable: Vg(0, !1) })))
                : (Zg(e, $S) || nk(e, $S, Vg(1, {})), (e[$S][r] = !0)),
              hk(e, r, n))
            : nk(e, r, n)
        );
      },
      ...
      yk = function (e, t) {
        ...
        if (n !== QS || !Zg(ok, r) || Zg(ak, r)) {
          var i = tk(n, r);
          return (
            !i || !Zg(ok, r) || (Zg(n, $S) && n[$S][r]) || (i.enumerable = !0),
            i
          );
        }
      },
    ...
    if (
      (mv ||
        (Mm(
          (ZS = function () {
            ...
            var e =
              ...
              n = function (e) {
                this === QS && n.call(ak, e),
                  Zg(this, $S) && Zg(this[$S], t) && (this[$S][t] = !1),
                  hk(this, t, Vg(1, e));
              };
            return (
              Fg && fk && hk(QS, t, { configurable: !0, set: n }), pk(t, e)
            );
          }).prototype,
          "toString",
          function () {
        ...
        Fg &&
          (nk(ZS.prototype, "description", {
            configurable: !0,
            get: function () {
              return JS(this).description;
            },
          }),
          Mm(QS, "propertyIsEnumerable", vk, { unsafe: !0 }))),
      hv({ global: !0, wrap: !0, forced: !mv, sham: !mv }, { Symbol: ZS }),
      YS(Xv(uk), function (e) {
        !(function (e) {
          var t = Um.Symbol || (Um.Symbol = {});
          Zg(t, e) || zS(t, e, { value: WS.f(e) });
        })(e);
      }),
      hv(
        { target: GS, stat: !0, forced: !mv },
        {
          for: function (e) {
            var t = String(e);
      ...
      hv(
        { target: "Object", stat: !0, forced: !mv, sham: !Fg },
        {
          create: function (e, t) {
      ...
      hv(
        { target: "Object", stat: !0, forced: !mv },
        { getOwnPropertyNames: bk, getOwnPropertySymbols: wk }
      ),
      hv(
        {
          target: "Object",
      ...
      var _k =
        ...
        Dg(function () {
          var e = ZS();
          return (
            "[null]" != ek([e]) || "{}" != ek({ a: e }) || "{}" != ek(Object(e))
          );
        });
      hv(
        { target: "JSON", stat: !0, forced: _k },
        {
          stringify: function (e, t, n) {
            for (var r, i = [e], o = 1; arguments.length > o; )
              i.push(arguments[o++]);
            if (((r = t), (Xg(t) || void 0 !== e) && !dk(e)))
              return (
                pv(t) ||
                  (t = function (e, t) {
                    if (
    ...
    ZS.prototype[KS] || um(ZS.prototype, KS, ZS.prototype.valueOf),
      zy(ZS, GS),
      (xm[$S] = !0),
      hv(
        { target: "Number", stat: !0 },
    ...
    hv(
      { target: "Object", stat: !0, forced: !Fg || Sk, sham: !Fg },
      {
        getOwnPropertyDescriptor: function (e, t) {
          return Ek(Kg(e), t);
        },
      ...
      hv(
        { target: "Object", stat: !0, sham: !Fg },
        {
          getOwnPropertyDescriptors: function (e) {
            for (
              var t, n, r = Kg(e), i = om.f, o = nv(r), a = {}, s = 0;
              o.length > s;

            )
              void 0 !== (n = i(r, (t = o[s++]))) && gv(a, t, n);
            return a;
          },
        }
      ),
        ...
        return [
          ...
          function (e) {
            ...
            for (var s, c = [], u = 0; null !== (s = _w(i, o)); ) {
              var l = String(s[0]);
              (c[u] = l),
                "" === l && (i.lastIndex = l_(o, Wm(i.lastIndex), a)),
                u++;
            }
            return 0 === u ? null : c;
          },
    ...
    var Ok = { addCSS: !0, thumbWidth: 15, watch: !0 };
    function Ik(e, t) {
      return function () {
        return Array.from(document.querySelectorAll(t)).includes(this);
      }.call(e, t);
    ...
    var Ck = function (e) {
      ...
      Hk = function (e) {
        return (
          jk(e) ||
          ((Lk(e) || Nk(e) || Mk(e)) && !e.length) ||
          (Rk(e) && !Object.keys(e).length)
        );
      };
    function Vk(e, t) {
      if (1 > t) {
      ...
      $k = (function () {
        function e(t, n) {
          (function (e, t) {
            ...
            qk(t)
              ? (this.element = t)
              : Uk(t) && (this.element = document.querySelector(t)),
            qk(this.element) &&
              Hk(this.element.rangeTouch) &&
              ((this.config = Ak({}, Ok, {}, n)), this.init());
        }
        return (
          (function (e, t, n) {
    ...
    (eT && tT) ||
      ...
      Qk
        ...
        : rT && !Jk
        ? ((Yk = (zk = new rT()).port2),
          (zk.port1.onmessage = lT),
          (Wk = Dv(Yk.postMessage, Yk, 1)))
        : Ug.addEventListener &&
          "function" == typeof postMessage &&
          !Ug.importScripts &&
          Zk &&
          "file:" !== Zk.protocol &&
          !Dg(fT)
        ? ((Wk = fT), Ug.addEventListener("message", lT, !1))
        : (Wk =
            sT in nm("script")
              ? function (e) {
                  Qv.appendChild(nm("script")).onreadystatechange =
                    function () {
    ...
    OT ||
      ...
      !Jk && !Qk && ST && kT
        ? ((mT = !0),
          (vT = kT.createTextNode("")),
          new ST(hT).observe(vT, { characterData: !0 }),
          (gT = function () {
            vT.data = mT = !mT;
          }))
        : xT && xT.resolve
        ? ((yT = xT.resolve(void 0)),
          (bT = yT.then),
          (gT = function () {
            bT.call(yT, hT);
          }))
    ...
    var IT,
      ...
      ex = lv(qT, function () {
        ...
        return (
          ((e.constructor = {})[FT] = t), !(e.then(function () {}) instanceof t)
        );
      }),
      tx =
        ex ||
        ...
        if (!e.notified) {
          ...
          RT(function () {
            for (var r = e.value, i = 1 == e.state, o = 0; n.length > o; ) {
              ...
              try {
                l
                  ? (i || (2 === e.rejection && sx(e), (e.rejection = 1)),
                    !0 === l
                      ? (a = r)
                      : (p && p.enter(), (a = l(r)), p && (p.exit(), (c = !0))),
                    a === u.promise
                      ? h(zT("Promise-chain cycle"))
                      : (s = nx(a))
                      ? s.call(a, f, h)
                      : f(a))
                  : h(r);
      ...
      ix = function (e, t, n) {
        var r, i;
        JT
          ? (((r = YT.createEvent("Event")).promise = t),
            (r.reason = n),
            r.initEvent(e, !1, !0),
            Ug.dispatchEvent(r))
    ...
    ex &&
      ...
      hv({ global: !0, wrap: !0, forced: ex }, { Promise: WT }),
      zy(WT, qT, !1),
      Xk(qT),
      (PT = Fm(qT)),
      hv(
        { target: qT, stat: !0, forced: ex },
        {
          reject: function (e) {
            var t = KT(this);
            return t.reject.call(void 0, e), t.promise;
    ...
    var fx,
      ...
      gx = aw("startsWith"),
      mx = !(
        gx || ((fx = hx(String.prototype, "startsWith")), !fx || fx.writable)
      );
    hv(
      { target: "String", proto: !0, forced: !mx && !gx },
      {
        startsWith: function (e) {
          var t = String(Gg(this));
          iw(e);
          var n = Wm(
              dx(arguments.length > 1 ? arguments[1] : void 0, t.length)
            ),
            r = String(e);
    ...
    var vx,
      ...
      Ox = function (e) {
        return (
          Ex(e) ||
          ((kx(e) || xx(e) || Ax(e)) && !e.length) ||
          (Sx(e) && !Object.keys(e).length)
        );
      },
      Ix = Ex,
      Cx = Sx,
    ...
    function Qx() {
      ...
      return Cx(i)
        ? (Object.keys(i).forEach(function (t) {
            Cx(i[t])
              ? (Object.keys(e).includes(t) || Object.assign(e, gs({}, t, {})),
                Qx(e[t], i[t]))
              : Object.assign(e, gs({}, t, i[t]));
          }),
          Qx.apply(void 0, [e].concat(n)))
        : e;
    }
    function Zx(e, t) {
      var n = e.length ? e : [e];
    ...
    function rA(e) {
      Mx(e) || Nx(e)
        ? Array.from(e).forEach(rA)
        : Ux(e) && Ux(e.parentNode) && e.parentNode.removeChild(e);
    }
    function iA(e) {
      if (Ux(e))
    ...
    function oA(e, t) {
      return Ux(t) && Ux(t.parentNode) && Ux(e)
      ...
      return (
        e.split(",").forEach(function (e) {
          ...
          switch (t.charAt(0)) {
            case ".":
              jx(r.class)
                ? (n.class = "".concat(r.class, " ").concat(i))
                : (n.class = i);
              break;
            case "#":
              n.id = t.replace("#", "");
    ...
    var dA,
      ...
      mA = {
        ...
        pip: !(
          Yx.isIPhone ||
          (!Lx(tA("video").webkitSetPresentationMode) &&
            (!document.pictureInPictureEnabled ||
              tA("video").disablePictureInPicture))
        ),
    ...
    function kA() {
      ...
      return new Promise(function (t) {
        return e.ready
          ? setTimeout(t, 0)
          : bA.call(e, e.elements.container, "ready", t);
      }).then(function () {});
    }
    function TA(e) {
    ...
    function xA(e) {
      return (
        !!(Nx(e) || (jx(e) && e.includes(":"))) &&
        (Nx(e) ? e : e.split(":")).map(Number).every(Px)
      );
    }
    function AA(e) {
    ...
    function IA(e) {
      ...
      var t = this.elements.wrapper,
        ...
        i = (100 / r[0]) * r[1];
      if (
        ((t.style.paddingBottom = "".concat(i, "%")),
      ...
      setup: function () {
        if (this.isHTML5) {
          ...
          (e.options.speed = e.config.speed.options),
            Vx(this.config.ratio) || IA.call(e),
            Object.defineProperty(e.media, "quality", {
              ...
              set: function (t) {
                if (e.quality !== t) {
                  if (e.config.quality.forced && Lx(e.config.quality.onChange))
                  ...
                  EA.call(e, e.media, "qualitychange", !1, { quality: t });
                }
              },
            });
        }
    ...
    var jA = Cv("slice"),
      RA = zv("slice", { ACCESSORS: !0, 0: 0, 1: 2 }),
      LA = _v("species"),
      NA = [].slice,
      MA = Math.max;
    hv(
      { target: "Array", proto: !0, forced: !jA || !RA },
      {
        slice: function (e, t) {
          var n,
            r,
          ...
          if (
            ...
            ("function" != typeof (n = o.constructor) ||
            (n !== Array && !pv(n.prototype))
              ? Xg(n) && null === (n = n[LA]) && (n = void 0)
              : (n = void 0),
            n === Array || void 0 === n)
          )
            return NA.call(o, s, c);
          for (
            r = new (void 0 === n ? Array : n)(MA(c - s, 0)), i = 0;
            s < c;
            s++, i++
          )
            s in o && gv(r, i, o[s]);
    ...
    if (
      ...
      for (
        var $A = function (e, t) {
            ...
            zA
              ? i && !o && (e = e.source)
              : e instanceof $A && (o && (t = Bb.call(e)), (e = e.source)),
              YA &&
                (n = !!t && t.indexOf("y") > -1) &&
                (t = t.replace(/y/g, ""));
            var a = gb(zA ? new BA(e, t) : BA(e, t), r ? this : HA, $A);
            return YA && n && FA(a, { sticky: n }), a;
          },
          GA = function (e) {
            (e in $A) ||
              UA($A, e, {
          ...
          hs(this, e),
            ...
            gs(this, "set", function (t) {
              if (e.supported && n.enabled && Cx(t)) {
                ...
                Vx(r) && (r = {}),
                  Qx(r, t),
                  window.localStorage.setItem(n.key, JSON.stringify(r));
              }
            }),
    ...
    var pO = {
      getIconUrl: function () {
        var e =
          ...
          (Yx.isIE && !window.svg4everybody);
        return { url: this.config.iconUrl, cors: e };
      },
      findElements: function () {
        try {
          return (
            (this.elements.controls = hA.call(
              this,
            ...
            (this.elements.progress = hA.call(
              this,
      ...
      createIcon: function (e, t) {
        ...
        eA(o, Qx(t, { "aria-hidden": "true", focusable: "false" }));
      ...
      createBadge: function (e) {
        if (Vx(e)) return null;
        var t = tA("span", { class: this.config.classNames.menu.value });
        return (
          t.appendChild(
            tA("span", { class: this.config.classNames.menu.badge }, e)
          ),
          t
        );
      },
      createButton: function (e, t) {
        ...
        return (
          o.toggle
            ? (a.appendChild(
                pO.createIcon.call(this, o.iconPressed, {
                  class: "icon--pressed",
                })
              ),
              a.appendChild(
                pO.createIcon.call(this, o.icon, { class: "icon--not-pressed" })
              ),
              a.appendChild(
                pO.createLabel.call(this, o.labelPressed, {
                  class: "label--pressed",
                })
              ),
              a.appendChild(
                pO.createLabel.call(this, o.label, {
                  class: "label--not-pressed",
                })
              ))
            : (a.appendChild(pO.createIcon.call(this, o.icon)),
              a.appendChild(pO.createLabel.call(this, o.label))),
          Qx(r, aA(this.config.selectors.buttons[i], r)),
          eA(a, r),
          "play" === i
            ? (Nx(this.elements.buttons[i]) || (this.elements.buttons[i] = []),
      ...
      createRange: function (e, t) {
        var n = tA(
          "input",
          Qx(
            aA(this.config.selectors.inputs[e]),
            {
              type: "range",
              min: 0,
              max: 100,
        ...
        return (
          ...
          pO.updateRangeFill.call(this, n),
          $k.setup(n),
          n
        );
      },
      createProgress: function (e, t) {
        var n = tA(
          "progress",
          Qx(
            aA(this.config.selectors.display[e]),
            {
              min: 0,
              max: 100,
              value: 0,
        ...
        if ("volume" !== e) {
          ...
          var r = { played: "played", buffer: "buffered" }[e],
      ...
      bindMenuItemShortcuts: function (e, t) {
        ...
        bA.call(
          ...
          function (r) {
            if (
              [32, 38, 39, 40].includes(r.which) &&
              (r.preventDefault(), r.stopPropagation(), "keydown" !== r.type)
            ) {
              var i,
                o = lA(e, '[role="menuitemradio"]');
              if (!o && [32, 39].includes(r.which))
                pO.showMenuPanel.call(n, t, !0);
              else
                32 !== r.which &&
                  (40 === r.which || (o && 39 === r.which)
                    ? ((i = e.nextElementSibling),
                      Ux(i) || (i = e.parentNode.firstElementChild))
                    : ((i = e.previousElementSibling),
                      Ux(i) || (i = e.parentNode.lastElementChild)),
                  pA.call(n, i, !0));
            }
          },
          !1
        ),
          bA.call(this, e, "keyup", function (e) {
      ...
      createMenuItem: function (e) {
        ...
        (h.innerHTML = o),
          ...
          pO.bindMenuItemShortcuts.call(this, f, i),
          r.appendChild(f);
      },
      formatTime: function () {
        var e =
      ...
      updateVolume: function () {
        this.supported.ui &&
          (Ux(this.elements.inputs.volume) &&
            pO.setRange.call(
              this,
              this.elements.inputs.volume,
              this.muted ? 0 : this.volume
            ),
          Ux(this.elements.buttons.mute) &&
            ...
            switch (e.type) {
              ...
              case "seeked":
                (n = (function (e, t) {
                  ...
                  "timeupdate" === e.type &&
                    pO.setRange.call(this, this.elements.inputs.seek, n);
                break;
              case "playing":
              case "progress":
                !(function (e, n) {
      ...
      updateRangeFill: function (e) {
        ...
        if (Ux(t) && "range" === t.getAttribute("type")) {
          if (lA(t, this.config.selectors.inputs.seek)) {
            ...
            t.setAttribute(
              "aria-valuetext",
              i.replace("{currentTime}", n).replace("{duration}", r)
            );
      ...
      updateSeekTooltip: function (e) {
        ...
        if (
          ...
          Ux(this.elements.inputs.seek) &&
          Ux(this.elements.display.seekTooltip) &&
          0 !== this.duration
        ) {
      ...
      durationUpdate: function () {
        if (
          ...
          if (this.duration >= Math.pow(2, 32))
            return (
              sA(this.elements.display.currentTime, !0),
              void sA(this.elements.progress, !0)
            );
          Ux(this.elements.inputs.seek) &&
          ...
          !e &&
            ...
            pO.updateSeekTooltip.call(this);
        }
      },
      ...
      updateSetting: function (e, t, n) {
        ...
        if ("captions" === e) i = this.currentTrack;
          ...
          if (
            ((i = Vx(n) ? this[e] : n),
            Vx(i) && (i = this.config[e].default),
            !Vx(this.options[e]) && !this.options[e].includes(i))
          )
            return void this.debug.warn(
              "Unsupported value of '".concat(i, "' for ").concat(e)
            );
          if (!this.config[e].options.includes(i))
            return void this.debug.warn(
              "Disabled value of '".concat(i, "' for ").concat(e)
            );
        }
        if ((Ux(o) || (o = r && r.querySelector('[role="menu"]')), Ux(o))) {
          this.elements.settings.buttons[e].querySelector(
            ".".concat(this.config.classNames.menu.value)
          ).innerHTML = pO.getLabel.call(this, e, i);
      ...
      setQualityMenu: function (e) {
        ...
        if (Ux(this.elements.settings.panels.quality)) {
          ...
          Nx(e) &&
            (this.options.quality = PA(e).filter(function (e) {
              return t.config.quality.options.includes(e);
            }));
          var i = !Vx(this.options.quality) && this.options.quality.length > 1;
          if (
            (pO.toggleMenuButton.call(this, n, i),
            iA(r),
            pO.checkMenu.call(this),
            i)
          ) {
            var o = function (e) {
      ...
      setCaptionsMenu: function () {
        ...
        if (Ux(this.elements.settings.panels.captions)) {
          var t = "captions",
            ...
            i = Boolean(r.length);
          if (
            (pO.toggleMenuButton.call(this, t, i),
            iA(n),
            pO.checkMenu.call(this),
            i)
          ) {
            var o = r.map(function (t, r) {
              return {
                ...
                badge:
                  t.language &&
                  pO.createBadge.call(e, t.language.toUpperCase()),
                list: n,
                type: "language",
              };
            });
            o.unshift({
              ...
              o.forEach(pO.createMenuItem.bind(this)),
      ...
      setSpeedMenu: function () {
        ...
        if (Ux(this.elements.settings.panels.speed)) {
          ...
          pO.toggleMenuButton.call(this, t, r),
            iA(n),
            pO.checkMenu.call(this),
            r &&
              (this.options.speed.forEach(function (r) {
      ...
      toggleMenu: function (e) {
        ...
        if (Ux(t) && Ux(n)) {
          ...
          n.setAttribute("aria-expanded", i),
            sA(t, !i),
            cA(this.elements.container, this.config.classNames.menu.open, i),
            i && Fx(e)
              ? pO.focusFirstMenuItem.call(this, null, !0)
              : i || r || pA.call(this, n, Fx(e));
        }
      },
      ...
      showMenuPanel: function () {
        var e = this,
          t =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
          n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
          r = this.elements.container.querySelector(
      ...
      create: function (e) {
        ...
        var f = { class: "plyr__controls__item" };
        return (
          PA(Nx(this.config.controls) ? this.config.controls : []).forEach(
            function (s) {
              if (
                ("restart" === s && l.appendChild(r.call(t, "restart", f)),
                "rewind" === s && l.appendChild(r.call(t, "rewind", f)),
                "play" === s && l.appendChild(r.call(t, "play", f)),
                "fast-forward" === s &&
                  l.appendChild(r.call(t, "fast-forward", f)),
                "progress" === s)
              ) {
                var c = tA("div", {
              ...
              if (
                ("current-time" === s &&
                  l.appendChild(a.call(t, "currentTime", f)),
                "duration" === s && l.appendChild(a.call(t, "duration", f)),
                "mute" === s || "volume" === s)
              ) {
                ...
                if (
                  ((Ux(d) && l.contains(d)) ||
                    ...
                    (t.elements.volume = d),
                    l.appendChild(d)),
                  "mute" === s && d.appendChild(r.call(t, "mute")),
                  "volume" === s && !Yx.isIos)
                ) {
                  ...
                  d.appendChild(
                    o.call(
                      t,
                      "volume",
                      Qx(g, { id: "plyr-volume-".concat(e.id) })
                    )
                  );
                }
              }
              if (
                ("captions" === s && l.appendChild(r.call(t, "captions", f)),
                "settings" === s && !Vx(t.config.settings))
              ) {
                var m = tA(
                  "div",
                  Qx({}, f, {
                ...
                var v = tA("div", {
                  ...
                  y = tA("div"),
                  b = tA("div", { id: "plyr-settings-".concat(e.id, "-home") }),
                  w = tA("div", { role: "menu" });
                b.appendChild(w),
                  y.appendChild(b),
                  ...
                  t.config.settings.forEach(function (r) {
                    var i = tA(
                      "button",
                      Qx(aA(t.config.selectors.buttons.settings), {
                        type: "button",
                        class: ""
                    ...
                    n.call(t, i, r),
                      bA.call(t, i, "click", function () {
                        u.call(t, r, !1);
                      });
                    var o = tA("span", null, rO(r, t.config)),
                      a = tA("span", { class: t.config.classNames.menu.value });
                    (a.innerHTML = e[r]),
                      o.appendChild(a),
                      i.appendChild(o),
                      w.appendChild(i);
                    ...
                    c.appendChild(
                      tA("span", { "aria-hidden": !0 }, rO(r, t.config))
                    ),
                      c.appendChild(
                        tA(
                          "span",
                          { class: t.config.classNames.hidden },
                          rO("menuBack", t.config)
                        )
                      ),
                      bA.call(
                        t,
                      ...
                      bA.call(t, c, "click", function () {
                        u.call(t, "home", !1);
                      }),
                      s.appendChild(c),
                      s.appendChild(tA("div", { role: "menu" })),
                      y.appendChild(s),
              ...
              if (
                ("pip" === s && mA.pip && l.appendChild(r.call(t, "pip", f)),
                "airplay" === s &&
                  mA.airplay &&
                  l.appendChild(r.call(t, "airplay", f)),
                "download" === s)
              ) {
                var _ = Qx({}, f, {
                  element: "a",
          ...
          this.isHTML5 && s.call(this, CA.getQualityOptions.call(this)),
          c.call(this),
          l
        );
      },
      inject: function () {
        ...
        var r = {
          ...
          i = !0;
        Lx(this.config.controls) &&
          (this.config.controls = this.config.controls.call(this, r)),
          this.config.controls || (this.config.controls = []),
          Ux(this.config.controls) || jx(this.config.controls)
            ? (n = this.config.controls)
            : ((n = pO.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
        ...
        if (
          (i &&
            ...
            (n = o)),
          jx(this.config.selectors.controls.container) &&
            (a = document.querySelector(
              this.config.selectors.controls.container
            )),
          Ux(a) || (a = this.elements.container),
          a[Ux(n) ? "insertAdjacentElement" : "insertAdjacentHTML"](
            "afterbegin",
            n
          ),
          Ux(this.elements.controls) || pO.findElements.call(this),
          !Vx(this.elements.buttons))
        ) {
          var s = function (t) {
        ...
        if ((Yx.isEdge && zx(a), this.config.tooltips.controls)) {
          var c = this.config,
            ...
            l = c.selectors,
            f = ""
              .concat(l.controls.wrapper, " ")
              .concat(l.labels, " .")
              .concat(u.hidden),
            h = fA.call(this, f);
          Array.from(h).forEach(function (t) {
            cA(t, e.config.classNames.hidden, !1),
              cA(t, e.config.classNames.tooltip, !0);
          });
        }
      },
    };
    ...
    var mO = {
        setup: function () {
          if (this.supported.ui)
            if (
              !this.isVideo ||
              this.isYouTube ||
              (this.isHTML5 && !mA.textTracks)
            )
              Nx(this.config.controls) &&
                this.config.controls.includes("settings") &&
                this.config.settings.includes("captions") &&
                pO.setCaptionsMenu.call(this);
            else {
              if (
                (Ux(this.elements.captions) ||
                  ((this.elements.captions = tA(
                    "div",
                    aA(this.config.selectors.captions)
                  )),
                  (function (e, t) {
                    Ux(e) &&
                      Ux(t) &&
              ...
              if (
                (Rx(r) || (r = this.config.captions.active),
                ...
                var i = this.config.captions.update
            ...
            t
              ...
              .forEach(function (t) {
                e.debug.log("Track added", t),
                  ...
                  bA.call(e, t, "cuechange", function () {
                    return mO.updateCues.call(e);
                  });
              }),
            ((s && this.language !== i) || !t.includes(a)) &&
              (mO.setLanguage.call(this, i), mO.toggle.call(this, r && s)),
            cA(
                ...
                var a = mO.getTracks.call(this),
                  s = mO.findTrack.call(
                    ...
                    [this.captions.language].concat(
                      ws(this.captions.languages)
                    ),
                    !0
                  );
                return (
                  (this.captions.language = s.language),
                  void mO.set.call(this, a.indexOf(s))
                );
              }
              this.elements.buttons.captions &&
                (this.elements.buttons.captions.pressed = o),
                cA(this.elements.container, i, o),
                (this.captions.toggled = o),
                pO.updateSetting.call(this, "captions"),
                EA.call(
                  this,
                  this.media,
              ...
              if (e in n) {
                if (this.captions.currentTrack !== e) {
                  ...
                  (this.captions.currentTrackNode = r),
                    ...
                    EA.call(this, this.media, "languagechange");
                }
                mO.toggle.call(this, !0, t),
                  this.isHTML5 && this.isVideo && mO.updateCues.call(this);
        ...
        getLabel: function (e) {
          ...
          return (
            !qx(t) &&
              ...
              (t = mO.getCurrentTrack.call(this)),
            qx(t)
              ? Vx(t.label)
                ? Vx(t.language)
                  ? rO("enabled", this.config)
                  : e.language.toUpperCase()
                : t.label
              : rO("disabled", this.config)
          );
        },
              ...
              if (Ix(e) || Array.isArray(e)) {
                ...
                if (r !== this.elements.captions.innerHTML) {
                  ...
                  (i.innerHTML = r),
                    ...
                    EA.call(this, this.media, "cuechange");
                }
      ...
      bO = "inline",
      wO = { html5: "html5", youtube: "youtube", vimeo: "vimeo" },
      _O = "audio",
      EO = "video";
    var SO = function () {},
      kO = (function () {
          ...
          hs(this, e),
            ...
            gs(this, "toggleFallback", function () {
              ...
              if (
                ...
                cA(n.target, n.player.config.classNames.fullscreen.fallback, e),
                Yx.isIos)
              ) {
            ...
            gs(this, "trapFocus", function (e) {
              if (!Yx.isIos && n.active && "Tab" === e.key && 9 === e.keyCode) {
                var t = document.activeElement,
                  ...
                  o = r[r.length - 1];
                t !== o || e.shiftKey
                  ? t === i && e.shiftKey && (o.focus(), e.preventDefault())
            ...
            gs(this, "update", function () {
              ...
              n.enabled
                ? ((t = n.forceFallback
                    ...
                    ? "Native"
                    : "Fallback"),
                  n.player.debug.log("".concat(t, " fullscreen enabled")))
                : n.player.debug.log(
            ...
            gs(this, "enter", function () {
              n.enabled &&
                (Yx.isIos && n.player.config.fullscreen.iosNative
                  ? n.player.isVimeo
            ...
            gs(this, "exit", function () {
              if (n.enabled)
                if (Yx.isIos && n.player.config.fullscreen.iosNative)
                  n.target.webkitExitFullscreen(), TA(n.player.play());
                else if (!e.native || n.forceFallback) n.toggleFallback(!1);
                else if (n.prefix) {
                  if (!Vx(n.prefix)) {
                    var t = "moz" === n.prefix ? "Cancel" : "Exit";
                    document[
                      "".concat(n.prefix).concat(t).concat(n.property)
                    ]();
                  }
                } else
          ...
          ds(
            ...
            [
              ...
              },
              {
                key: "target",
                get: function () {
                  return Yx.isIos && this.player.config.fullscreen.iosNative
                    ? this.player.media
                    : this.player.elements.fullscreen ||
                        this.player.elements.container;
                },
                ...
                get: function () {
                  ...
                  return (
                    ["webkit", "moz", "ms"].some(function (t) {
                      return (
                        !(
                          !Lx(document["".concat(t, "ExitFullscreen")]) &&
                          !Lx(document["".concat(t, "CancelFullScreen")])
                        ) && ((e = t), !0)
                      );
                    }),
                    e
    ...
    var OO = {
        ...
        build: function () {
          ...
          if ((this.listeners.media(), !this.supported.ui))
            return (
              ...
              void OO.toggleNativeControls.call(this, !0)
            );
          Ux(this.elements.controls) ||
            (pO.inject.call(this), this.listeners.controls()),
            OO.toggleNativeControls.call(this),
            this.isHTML5 && mO.setup.call(this),
            (this.volume = null),
            (this.muted = null),
            (this.loop = null),
            (this.quality = null),
            (this.speed = null),
            pO.updateVolume.call(this),
            pO.timeUpdate.call(this),
            OO.checkPlaying.call(this),
            cA(
              this.elements.container,
              this.config.classNames.pip.supported,
              mA.pip && this.isHTML5 && this.isVideo
            ),
            cA(
              this.elements.container,
              this.config.classNames.airplay.supported,
              mA.airplay && this.isHTML5
            ),
            cA(this.elements.container, this.config.classNames.isIos, Yx.isIos),
            cA(
              this.elements.container,
            ...
            OO.setTitle.call(this),
            this.poster &&
              OO.setPoster.call(this, this.poster, !1).catch(function () {}),
            this.config.duration && pO.durationUpdate.call(this);
        },
        setTitle: function () {
          var e = rO("play", this.config);
          if (
            (jx(this.config.title) &&
              !Vx(this.config.title) &&
          ...
          cA(
            ...
            Array.from(this.elements.buttons.play || []).forEach(function (e) {
              Object.assign(e, { pressed: t.playing }),
                e.setAttribute(
                  "aria-label",
                  rO(t.playing ? "pause" : "play", t.config)
                );
            }),
        ...
        migrateStyles: function () {
          var e = this;
          Object.values(vs({}, this.media.style))
            .filter(function (e) {
          ...
          hs(this, e),
            ...
            gs(this, "setTabFocus", function (e) {
              ...
              if (
                ...
                var i,
                  o = e.timeStamp - n.lastKeyDown <= 20;
                if ("focus" !== e.type || o)
                  (i = t.config.classNames.tabFocus),
                    cA(fA.call(t, ".".concat(i)), i, !1),
                    "focusout" !== e.type &&
                      (n.focusTimer = setTimeout(function () {
                        var e = document.activeElement;
                        r.container.contains(e) &&
                          cA(
            ...
            gs(this, "global", function () {
              ...
              t.config.keyboard.global &&
                yA.call(t, window, "keydown keyup", n.handleKey, e, !1),
                yA.call(t, document.body, "click", n.toggleMenu, e),
                _A.call(t, document.body, "touchstart", n.firstTouch),
                yA.call(
                  t,
                  document.body,
            ...
            gs(this, "container", function () {
              ...
              !t.keyboard.global &&
                t.keyboard.focused &&
                bA.call(e, r.container, "keydown keyup", n.handleKey, !1),
                bA.call(
                  e,
                  r.container,
                ...
                function (t) {
                  ...
                  if (i === r.container && (e.isEmbed || !Vx(e.config.ratio))) {
                    ...
                    !(function (t, n, r) {
                      ...
                      s ||
                        (c
                          ? bA.call(e, window, "resize", a)
                          : wA.call(e, window, "resize", a));
                  }
                }
              );
            }),
            gs(this, "media", function () {
              var e = n.player,
                t = e.elements;
              if (
                (bA.call(e, e.media, "timeupdate seeking seeked", function (t) {
                ...
                bA.call(e, t.container, "click", function (i) {
                  ([t.container, r].includes(i.target) ||
                    r.contains(i.target)) &&
                    ((e.touch && e.config.hideControls) ||
                      (e.ended
                        ? (n.proxy(i, e.restart, "restart"),
                          n.proxy(
                            i,
                            function () {
                              TA(e.play());
              ...
              e.supported.ui &&
                ...
                bA.call(e, e.media, "volumechange", function () {
                  e.storage.set({ volume: e.volume, muted: e.muted });
                }),
                bA.call(e, e.media, "ratechange", function () {
                  pO.updateSetting.call(e, "speed"),
              ...
              bA.call(e, e.media, i, function (n) {
                ...
                "error" === n.type && (i = e.media.error),
                  EA.call(e, t.container, n.type, !0, i);
              });
            }),
            ...
            gs(this, "controls", function () {
              ...
              if (
                ...
                n.bind(t.buttons.restart, "click", e.restart, "restart"),
                n.bind(
                  t.buttons.rewind,
                  "click",
                  function () {
                ...
                n.bind(t.buttons.captions, "click", function () {
                ...
                n.bind(t.buttons.airplay, "click", e.airplay, "airplay"),
                n.bind(
                  t.buttons.settings,
                  "click",
                  function (t) {
                    ...
                    [13, 32].includes(n) &&
                      (13 !== n
                        ? (t.preventDefault(),
                          t.stopPropagation(),
                          pO.toggleMenu.call(e, t))
                        : pO.focusFirstMenuItem.call(e, null, !0));
                  },
                  null,
                  !1
                ),
                n.bind(t.settings.menu, "keydown", function (t) {
                ...
                n.bind(
                  ...
                  function (t) {
                    ...
                    if (!Fx(t) || 39 === r || 37 === r) {
                      ...
                      o && a
                        ? (n.removeAttribute(i), TA(e.play()))
                        : !a && e.playing && (n.setAttribute(i, ""), e.pause());
                    }
                  }
                ),
                Yx.isIos)
              ...
              n.bind(
                ...
                Yx.isWebkit &&
                  Array.from(fA.call(e, 'input[type="range"]')).forEach(
                    function (t) {
                ...
                e.config.toggleInvert &&
                  !Ux(t.display.duration) &&
                  n.bind(t.display.currentTime, "click", function () {
                    0 !== e.currentTime &&
                      ((e.config.invertTime = !e.config.invertTime),
                      pO.timeUpdate.call(e));
                  }),
                n.bind(
                  t.inputs.volume,
                  r,
                ...
                n.bind(t.controls, "mouseenter mouseleave", function (n) {
                ...
                n.bind(t.controls, "focusin", function () {
                  var r = e.config,
                    i = e.timers;
                  cA(t.controls, r.classNames.noTransition, !0),
                    OO.toggleControls.call(e, !0),
                    setTimeout(function () {
                ...
                if (
                  ...
                  if (i) {
                    ...
                    if (Ux(a)) {
                      ...
                      if (32 === e.which && lA(a, 'button, [role^="menuitem"]'))
                        return;
                    }
                    switch (
                      ([
      ...
      CO = Cv("splice"),
      PO = zv("splice", { ACCESSORS: !0, 0: 0, 1: 2 }),
      jO = Math.max,
      RO = Math.min,
      LO = 9007199254740991,
        ...
        splice: function (e, t) {
          ...
          if (
            (0 === f
              ...
              : 1 === f
              ? ((n = 0), (r = u - l))
              : ((n = f - 2), (r = RO(jO(Hm(t), 0), u - l))),
            u + n - r > LO)
          )
            throw TypeError(NO);
          for (i = Sv(c, r), o = 0; o < r; o++)
            (a = l + o) in c && gv(i, o, c[a]);
          if (((i.length = r), n < r)) {
            for (o = l; o < u - r; o++)
              (s = o + n), (a = o + r) in c ? (c[s] = c[a]) : delete c[s];
            for (o = u; o > u - r + n; o--) delete c[o - 1];
        ...
        function u(e, n, r) {
          ...
          function u(t, n) {
            c(
              e,
              function (e) {
                a(s, e), t && a({ success: t, error: n }, e), o(i, e);
              },
              s
            );
          }
    ...
    function DO(e) {
      e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        this.media.paused === e &&
          ((this.media.paused = !e),
          EA.call(this, this.media, e ? "play" : "pause"));
    }
    var FO = {
      setup: function () {
        var e = this;
        cA(e.elements.wrapper, e.config.classNames.embed, !0),
          (e.options.speed = e.config.speed.options),
          IA.call(e),
          Cx(window.Vimeo)
            ? FO.ready.call(e)
            : UO(e.config.urls.vimeo.sdk)
                .then(function () {
                  FO.ready.call(e);
                })
                .catch(function (t) {
      ...
      ready: function () {
        ...
        r && Object.assign(o, { controls: !1, sidedock: !1 });
        var a = gO(
            vs(
              {
        ...
        if (
          ...
          Vx(i) || l.setAttribute("referrerPolicy", i),
          r || !n.customControls)
        )
          l.setAttribute("data-poster", t.poster), (t.media = oA(l, t.media));
        else {
          var h = tA("div", {
        ...
        n.customControls ||
          oO(JA(t.config.urls.vimeo.api, f)).then(function (e) {
            !Vx(e) &&
              e.thumbnail_url &&
              OO.setPoster.call(t, e.thumbnail_url).catch(function () {});
          }),
        ...
        Object.defineProperty(t.media, "loop", {
          ...
          t.embed.on("loaded", function () {
            ...
            Ux(t.embed.element) && t.supported.ui) &&
          ...
          t.embed.on("timeupdate", function (e) {
            (t.media.seeking = !1),
              (p = e.seconds),
              EA.call(t, t.media, "timeupdate");
          }),
          t.embed.on("progress", function (e) {
            (t.media.buffered = e.percent),
              EA.call(t, t.media, "progress"),
              1 === parseInt(e.percent, 10) &&
                EA.call(t, t.media, "canplaythrough"),
              t.embed.getDuration().then(function (e) {
                e !== t.media.duration &&
                  ((t.media.duration = e),
                  EA.call(t, t.media, "durationchange"));
              });
          }),
    ...
    var HO = {
        setup: function () {
          var e = this;
          if (
            (cA(this.elements.wrapper, this.config.classNames.embed, !0),
            Cx(window.YT) && Lx(window.YT.Player))
          )
            HO.ready.call(this);
          else {
        ...
        getTitle: function (e) {
          var t = this;
          oO(JA(this.config.urls.youtube.api, e))
            .then(function (e) {
              if (Cx(e)) {
                var n = e.title,
                  r = e.height,
          ...
          if (Vx(n) || !n.startsWith("youtube-")) {
            ...
            var i,
              ...
              s = tA("div", {
                id:
                  ((o = e.provider),
                  "".concat(o, "-").concat(Math.floor(1e4 * Math.random()))),
              ...
              events: {
                ...
                onPlaybackRateChange: function (t) {
                  ...
                  (e.media.playbackRate = n.getPlaybackRate()),
                    EA.call(e, e.media, "ratechange");
                },
                onReady: function (n) {
                  if (!Lx(e.media.play)) {
                    var r = n.target;
                    HO.getTitle.call(e, a),
                    ...
                    Object.defineProperty(e.media, "volume", {
                      ...
                      set: function (t) {
                        (i = t),
                          r.setVolume(100 * i),
                          EA.call(e, e.media, "volumechange");
                      },
                    });
                    ...
                    (e.options.speed = s.filter(function (t) {
                      ...
                      EA.call(e, e.media, "durationchange"),
                      clearInterval(e.timers.buffering),
                      (e.timers.buffering = setInterval(function () {
                        (e.media.buffered = r.getVideoLoadedFraction()),
                          (null === e.media.lastBuffered ||
                            e.media.lastBuffered < e.media.buffered) &&
                            EA.call(e, e.media, "progress"),
                          (e.media.lastBuffered = e.media.buffered),
                          1 === e.media.buffered &&
                            (clearInterval(e.timers.buffering),
                            EA.call(e, e.media, "canplaythrough"));
                      }, 200)),
                      t.customControls &&
                        setTimeout(function () {
                ...
                onStateChange: function (n) {
                  ...
                  switch (
                    ...
                    e.media.seeking &&
                      [1, 2].includes(n.data) &&
                      ((e.media.seeking = !1), EA.call(e, e.media, "seeked")),
                    n.data)
                  ) {
                    case -1:
                      EA.call(e, e.media, "timeupdate"),
        ...
        setup: function () {
          this.media
            ? (cA(
              ...
              this.isVideo &&
                ((this.elements.wrapper = tA("div", {
                  class: this.config.classNames.video,
                })),
                Zx(this.media, this.elements.wrapper),
                (this.elements.poster = tA("div", {
              ...
              this.isHTML5
                ...
                : this.isYouTube
                ? HO.setup.call(this)
                : this.isVimeo && FO.setup.call(this))
      ...
      WO = (function () {
        function e(t) {
          var n = this;
          hs(this, e),
            gs(this, "load", function () {
              n.enabled &&
                (Cx(window.google) && Cx(window.google.ima)
                  ? n.ready()
                  : UO(n.player.config.urls.googleIMA.sdk)
                      .then(function () {
                        n.ready();
                      })
                      .catch(function () {
            ...
            gs(this, "setupIMA", function () {
              (n.elements.container = tA("div", {
                ...
                n.player.elements.container.appendChild(n.elements.container),
                google.ima.settings.setVpaidMode(
                  google.ima.ImaSdkSettings.VpaidMode.ENABLED
                ),
                google.ima.settings.setLocale(n.player.config.ads.language),
                google.ima.settings.setDisableCustomPlaybackForIOS10Plus(
                  n.player.config.playsinline
                ),
                (n.elements.displayContainer =
                  new google.ima.AdDisplayContainer(
                    n.elements.container,
                    n.player.media
                  )),
                (n.loader = new google.ima.AdsLoader(
                  n.elements.displayContainer
                )),
                n.loader.addEventListener(
            ...
            gs(this, "requestAds", function () {
              ...
              try {
                ...
                (t.adTagUrl = n.tagUrl),
                  ...
                  t.setAdWillPlayMuted(!n.player.muted),
                  n.loader.requestAds(t);
              } catch (e) {
                n.onAdError(e);
              }
            }),
            gs(this, "pollCountdown", function () {
              ...
              if (!e)
                return (
                  clearInterval(n.countdownTimer),
                  void n.elements.container.removeAttribute("data-badge-text")
                );
              var t = function () {
                var e = hO(Math.max(n.manager.getRemainingTime(), 0)),
                  t = ""
                    .concat(rO("advertisement", n.player.config), " - ")
                    .concat(e);
            ...
            gs(this, "onAdsManagerLoaded", function (e) {
              if (n.enabled) {
                ...
                (t.restoreCustomPlaybackStateOnAdBreakComplete = !0),
                  ...
                  (n.manager = e.getAdsManager(n.player, t)),
                  (n.cuePoints = n.manager.getCuePoints()),
            ...
            gs(this, "addCuePoints", function () {
              Vx(n.cuePoints) ||
                n.cuePoints.forEach(function (e) {
            ...
            gs(this, "onAdEvent", function (e) {
              ...
              switch (
                ...
                case google.ima.AdEvent.Type.LOG:
                  i.adError &&
                    n.player.debug.warn(
                      "Non-fatal ad error: ".concat(i.adError.getMessage())
                    );
              }
            }),
            ...
            gs(this, "listeners", function () {
              ...
              n.player.on("canplay", function () {
                ...
                n.player.on("seeked", function () {
                  ...
                  Vx(n.cuePoints) ||
                    n.cuePoints.forEach(function (r, i) {
                      e < r &&
                        r < t &&
                        (n.manager.discardAdBreak(), n.cuePoints.splice(i, 1));
                    });
                }),
            ...
            gs(this, "play", function () {
              var e = n.player.elements.container;
              n.managerPromise || n.resumeContent(),
                n.managerPromise
                  .then(function () {
                    n.manager.setVolume(n.player.volume),
                      n.elements.displayContainer.initialize();
                    try {
                      n.initialized ||
                        (n.manager.init(
                          e.offsetWidth,
            ...
            gs(this, "resumeContent", function () {
              (n.elements.container.style.zIndex = ""),
                (n.playing = !1),
                TA(n.player.media.play());
            }),
            gs(this, "pauseContent", function () {
              (n.elements.container.style.zIndex = 3),
                (n.playing = !0),
                n.player.media.pause();
            }),
            gs(this, "cancel", function () {
              n.initialized && n.resumeContent(),
                n.trigger("error"),
                n.loadAds();
            }),
            gs(this, "loadAds", function () {
              n.managerPromise
                .then(function () {
                  n.manager && n.manager.destroy(),
                    (n.managerPromise = new Promise(function (e) {
            ...
            gs(this, "on", function (e, t) {
              return (
                Nx(n.events[e]) || (n.events[e] = []), n.events[e].push(t), n
              );
            }),
            gs(this, "startSafetyTimer", function (e, t) {
              n.player.debug.log("Safety timer invoked from: ".concat(t)),
                (n.safetyTimer = setTimeout(function () {
                  n.cancel(), n.clearSafetyTimer("startSafetyTimer()");
                }, e));
            }),
            gs(this, "clearSafetyTimer", function (e) {
              Ix(n.safetyTimer) ||
                (n.player.debug.log("Safety timer cleared from: ".concat(e)),
                clearTimeout(n.safetyTimer),
                (n.safetyTimer = null));
            }),
            (this.player = t),
    ...
    YO in [] &&
      ...
      hv(
        { target: "Array", proto: !0, forced: $O || !GO },
        {
        ...
        JO || !QO || !ZO
          ? function (e) {
              ...
              var t = Kg(this),
                ...
                r = n - 1;
              for (
                arguments.length > 1 && (r = KO(r, Hm(arguments[1]))),
                  r < 0 && (r = n + r);
                r >= 0;
                r--
              )
          ...
          : XO;
    hv(
      { target: "Array", proto: !0, forced: eI !== [].lastIndexOf },
      { lastIndexOf: eI }
    );
    var tI = function (e, t) {
        var n = {};
      ...
      nI = (function () {
        function e(t) {
          ...
          hs(this, e),
            gs(this, "load", function () {
              n.player.elements.display.seekTooltip &&
                (n.player.elements.display.seekTooltip.hidden = n.enabled),
                n.enabled &&
                  n.getThumbnails().then(function () {
                    n.enabled &&
                      (n.render(),
                      n.determineContainerAutoSizing(),
                      (n.loaded = !0));
                  });
            }),
              ...
              return new Promise(function (t) {
                oO(e).then(function (r) {
                  ...
                  a.frames[0].text.startsWith("/") ||
                    ...
                    (a.urlPrefix = e.substring(0, e.lastIndexOf("/") + 1));
                  var s = new Image();
                  (s.onload = function () {
            ...
            gs(this, "startMove", function (e) {
              if (
                ...
                n.player.media.duration
              ) {
                if ("touchmove" === e.type)
                  n.seekTime =
                    n.player.media.duration *
                    (n.player.elements.inputs.seek.value / 100);
                else {
                  var t = n.player.elements.progress.getBoundingClientRect(),
                    r = (100 / t.width) * (e.pageX - t.left);
                  (n.seekTime = n.player.media.duration * (r / 100)),
                    n.seekTime < 0 && (n.seekTime = 0),
                    n.seekTime > n.player.media.duration - 1 &&
                      (n.seekTime = n.player.media.duration - 1),
                    (n.mousePosX = e.pageX),
                    (n.elements.thumb.time.innerText = hO(n.seekTime));
                }
            ...
            gs(this, "startScrubbing", function (e) {
              (Ix(e.button) || !1 === e.button || 0 === e.button) &&
                ((n.mouseDown = !0),
                n.player.media.duration &&
                  (n.toggleScrubbingContainer(!0),
                  n.toggleThumbContainer(!1, !0),
                  n.showImageAtCurrentTime()));
            }),
            gs(this, "endScrubbing", function () {
              (n.mouseDown = !1),
                Math.ceil(n.lastTime) === Math.ceil(n.player.media.currentTime)
                  ? n.toggleScrubbingContainer(!1)
                  : _A.call(
                      n.player,
                      n.player.media,
                      "timeupdate",
            ...
            gs(this, "render", function () {
              (n.elements.thumb.container = tA("div", {
                class:
                  n.player.config.classNames.previewThumbnails.thumbContainer,
              })),
                (n.elements.thumb.imageContainer = tA("div", {
                  class:
                    n.player.config.classNames.previewThumbnails.imageContainer,
                })),
                n.elements.thumb.container.appendChild(
                  n.elements.thumb.imageContainer
                );
              var e = tA("div", {
                class:
                  n.player.config.classNames.previewThumbnails.timeContainer,
              });
              (n.elements.thumb.time = tA("span", {}, "00:00")),
                e.appendChild(n.elements.thumb.time),
                n.elements.thumb.container.appendChild(e),
                Ux(n.player.elements.progress) &&
                  n.player.elements.progress.appendChild(
                    n.elements.thumb.container
                  ),
                (n.elements.scrubbing.container = tA("div", {
                  class:
                    n.player.config.classNames.previewThumbnails
                      .scrubbingContainer,
                })),
                n.player.elements.wrapper.appendChild(
                  n.elements.scrubbing.container
                );
            }),
            gs(this, "destroy", function () {
              n.elements.thumb.container && n.elements.thumb.container.remove(),
                n.elements.scrubbing.container &&
                  n.elements.scrubbing.container.remove();
            }),
            gs(this, "showImageAtCurrentTime", function () {
              n.mouseDown
                ? n.setScrubbingContainerSize()
                : n.setThumbContainerSizeAndPos();
              var e = n.thumbnails[0].frames.findIndex(function (e) {
                  return n.seekTime >= e.startTime && n.seekTime <= e.endTime;
                }),
                t = e >= 0,
                r = 0;
              n.mouseDown || n.toggleThumbContainer(t),
                t &&
                  (n.thumbnails.forEach(function (t, i) {
                    n.loadedImages.includes(t.frames[e].text) && (r = i);
                  }),
                  e !== n.showingThumb &&
                    ((n.showingThumb = e), n.loadImage(r)));
            }),
            gs(this, "loadImage", function () {
              var e =
                ...
                s = i + a;
              if (
                n.currentImageElement &&
                n.currentImageElement.dataset.filename === a
              )
                n.showImage(n.currentImageElement, o, e, t, a, !1),
                  (n.currentImageElement.dataset.index = t),
                  n.removeOldImages(n.currentImageElement);
              else {
                n.loadingImage &&
                  n.usingSprites &&
                  (n.loadingImage.onload = null);
                var c = new Image();
                (c.src = s),
                  (c.dataset.index = t),
                  (c.dataset.filename = a),
                  (n.showingThumbFilename = a),
                  n.player.debug.log("Loading image: ".concat(s)),
                  (c.onload = function () {
            ...
            gs(this, "showImage", function (e, t, r, i, o) {
              ...
              n.player.debug.log(
                ...
                n.setImageSizeAndOffset(e, t),
                a &&
                  (n.currentImageContainer.appendChild(e),
                  (n.currentImageElement = e),
                  n.loadedImages.includes(o) || n.loadedImages.push(o)),
                n
                  .preloadNearby(i, !0)
                  .then(n.preloadNearby(i, !1))
                  .then(n.getHigherQuality(r, e, t, o));
            }),
            gs(this, "removeOldImages", function (e) {
              Array.from(n.currentImageContainer.children).forEach(function (
                t
              ) {
              ...
              return new Promise(function (r) {
                setTimeout(function () {
                  ...
                  if (n.showingThumbFilename === i) {
                    var o;
                    o = t
                      ? n.thumbnails[0].frames.slice(e)
                      : n.thumbnails[0].frames.slice(0, e).reverse();
                    var a = !1;
                    o.forEach(function (e) {
                      var t = e.text;
                        ...
                        (s.src = o),
                          (s.onload = function () {
                            n.player.debug.log(
                              ...
                              n.loadedImages.includes(t) ||
                                n.loadedImages.push(t),
                              r();
                          });
                      }
                    }),
            ...
            gs(this, "getHigherQuality", function (e, t, r, i) {
              if (e < n.thumbnails.length - 1) {
                ...
                n.usingSprites && (o = r.h),
                  o < n.thumbContainerHeight &&
                    setTimeout(function () {
                      n.showingThumbFilename === i &&
                        (n.player.debug.log(
            ...
            gs(this, "toggleThumbContainer", function () {
              var e =
                ...
                r =
                  n.player.config.classNames.previewThumbnails
                    .thumbContainerShown;
              n.elements.thumb.container.classList.toggle(r, e),
                !e &&
                  t &&
                  ((n.showingThumb = null), (n.showingThumbFilename = null));
            }),
            gs(this, "toggleScrubbingContainer", function () {
              ...
              n.elements.scrubbing.container.classList.toggle(t, e),
                e || ((n.showingThumb = null), (n.showingThumbFilename = null));
            }),
            gs(this, "determineContainerAutoSizing", function () {
              (n.elements.thumb.imageContainer.clientHeight > 20 ||
                n.elements.thumb.imageContainer.clientWidth > 20) &&
                (n.sizeSpecifiedInCSS = !0);
            }),
            gs(this, "setThumbContainerSizeAndPos", function () {
              if (n.sizeSpecifiedInCSS) {
                if (
                  ...
                  var e = Math.floor(
                    n.elements.thumb.imageContainer.clientHeight *
                      n.thumbAspectRatio
                  );
                  n.elements.thumb.imageContainer.style.width = "".concat(
                    e,
                    "px"
                  );
                } else if (
                  ...
                  var t = Math.floor(
                    n.elements.thumb.imageContainer.clientWidth /
                      n.thumbAspectRatio
                  );
                  n.elements.thumb.imageContainer.style.height = "".concat(
                    t,
                    "px"
                  );
                }
            ...
            gs(this, "setScrubbingContainerSize", function () {
              var e = tI(n.thumbAspectRatio, {
                ...
                t = e.width,
                r = e.height;
              (n.elements.scrubbing.container.style.width = "".concat(t, "px")),
                (n.elements.scrubbing.container.style.height = "".concat(
                  r,
                  "px"
                ));
            }),
            gs(this, "setImageSizeAndOffset", function (e, t) {
              if (n.usingSprites) {
                ...
                (e.style.height = "".concat(e.naturalHeight * r, "px")),
                  (e.style.width = "".concat(e.naturalWidth * r, "px")),
                  (e.style.left = "-".concat(t.x * r, "px")),
                  (e.style.top = "-".concat(t.y * r, "px"));
              }
            }),
            (this.player = t),
            (this.thumbnails = []),
              ...
              this.destroy.call(
                ...
                function () {
                  ...
                  Object.assign(t, {
                    ...
                    OO.addStyleHook.call(t),
                    t.isHTML5 && rI.insertElements.call(t, "source", n),
                    (t.config.title = e.title),
                    VO.setup.call(t),
                    t.isHTML5 &&
                      Object.keys(e).includes("tracks") &&
                      rI.insertElements.call(t, "track", e.tracks),
                    (t.isHTML5 || (t.isEmbed && !t.supported.ui)) &&
                      OO.build.call(t),
                    t.isHTML5 && t.media.load(),
                    Vx(e.previewThumbnails) ||
                      (Object.assign(
          ...
          if (
            ...
            gs(this, "toggleControls", function (e) {
              if (r.supported.ui && !r.isAudio) {
                ...
                if (
                  (i &&
                    Nx(r.config.controls) &&
                    r.config.controls.includes("settings") &&
                    !Vx(r.config.settings) &&
                    pO.toggleMenu.call(r, !1),
                  i !== t)
                ) {
            ...
            gs(this, "destroy", function (e) {
              ...
              if (r.ready) {
                  ...
                  (document.body.style.overflow = ""),
                    ...
                    t
                      ? (Object.keys(r.elements).length &&
                          (rA(r.elements.buttons.play),
                          rA(r.elements.captions),
                          rA(r.elements.controls),
                          rA(r.elements.wrapper),
                        ...
                        Lx(e) && e())
                      : (SA.call(r),
                        CA.cancelRequests.call(r),
                        oA(r.elements.original, r.elements.container),
                        EA.call(r, r.elements.original, "destroyed", !0),
                        Lx(e) && e.call(r.elements.original),
                        (r.ready = !1),
                        setTimeout(function () {
                ...
                r.stop(),
                  ...
                  r.isHTML5
                    ? (OO.toggleNativeControls.call(r, !0), n())
                    : r.isYouTube
            ...
            (this.debug = new kO(this.config.debug)),
            this.debug.log("Config", this.config),
            this.debug.log("Support", mA),
            !Ix(this.media) && Ux(this.media))
          )
                  ...
                  case "div":
                    if (((a = this.media.querySelector("iframe")), Ux(a))) {
                      if (
                        ...
                        var c = ["1", "true"];
                        c.includes(s.searchParams.get("autoplay")) &&
                    ...
                    if (
                      Vx(this.provider) ||
                      !Object.values(wO).includes(this.provider)
                    )
                ...
                (this.supported = mA.check(
                  ...
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      (this.storage = new iO(this)),
                      (this.media.plyr = this),
                      Ux(this.elements.container) ||
                        ((this.elements.container = tA("div", { tabindex: 0 })),
                        Zx(this.media, this.elements.container)),
                      OO.migrateStyles.call(this),
                      OO.addStyleHook.call(this),
                      VO.setup.call(this),
                      this.config.debug &&
                        bA.call(
                          this,
                      ...
                      (this.fullscreen = new TO(this)),
                      (this.isHTML5 || (this.isEmbed && !this.supported.ui)) &&
                        OO.build.call(this),
                      this.listeners.container(),
                      this.listeners.global(),
                      this.config.ads.enabled && (this.ads = new WO(this)),
                      this.isHTML5 &&
                      ...
                      this.config.previewThumbnails.enabled &&
                        (this.previewThumbnails = new nI(this)))
            ...
            [
              ...
              },
              {
                ...
                set: function (e) {
                  var t = e;
                  jx(t) && (t = Number(t)),
                    Px(t) || (t = this.storage.get("volume")),
                    Px(t) || (t = this.config.volume),
                    t > 1 && (t = 1),
                    t < 0 && (t = 0),
                    (this.config.volume = t),
                    (this.media.volume = t),
                    !Vx(e) && this.muted && t > 0 && (this.muted = !1);
                },
                get: function () {
              ...
              },
              {
                ...
                set: function (e) {
                  var t = e;
                  Rx(t) || (t = this.storage.get("muted")),
                    Rx(t) || (t = this.config.muted),
                    (this.config.muted = t),
                    (this.media.muted = t);
                },
                get: function () {
              ...
              },
              {
                ...
                set: function (e) {
                  var t = this,
                    n = null;
                  Px(e) && (n = e),
                    Px(n) || (n = this.storage.get("speed")),
                    Px(n) || (n = this.config.speed.selected);
              ...
              },
              {
                ...
                get: function () {
                  return this.isYouTube
                    ? Math.min.apply(Math, ws(this.options.speed))
                    : this.isVimeo
                    ? 0.5
                    : 0.0625;
                },
              },
              {
                ...
                get: function () {
                  return this.isYouTube
                    ? Math.max.apply(Math, ws(this.options.speed))
                    : this.isVimeo
                    ? 2
                    : 16;
                },
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? OO.setPoster.call(this, e, !1).catch(function () {})
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? jx(e) && xA(e)
                      ? ((this.config.ratio = e), IA.call(this))
                      : this.debug.error(
              ...
              },
              {
                ...
                set: function (e) {
                  if (mA.pip) {
                    ...
                    Lx(this.media.webkitSetPresentationMode) &&
                      this.media.webkitSetPresentationMode(t ? yO : bO),
                      Lx(this.media.requestPictureInPicture) &&
                        (!this.pip && t
                ...
                get: function () {
                  return mA.pip
                    ? Vx(this.media.webkitPresentationMode)
                      ? this.media === document.pictureInPictureElement
                      : this.media.webkitPresentationMode === yO
                    : null;
                },
              },
            ],
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        function s(t, r) {
          !n.includes(t) ||
            (!r && t === i) ||
            (!i.length && "video" === t) ||
            ((e.source = sI[t]), (i = t), a(t));
        }
        Array.from(t).forEach(function (e) {
          e.addEventListener("click", function () {
            var t = e.getAttribute("data-source");
            s(t), r && window.history.pushState({ type: t }, "", "#".concat(t));
          });
        }),
